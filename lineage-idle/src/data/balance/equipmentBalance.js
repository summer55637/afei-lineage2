...
export const GRADES = Object.freeze([
  { id: 1, name: '無等級', label: 'NG', levelRange: [1, 19] },
  { id: 2, name: 'D 級', label: 'D', levelRange: [20, 39] },
  { id: 3, name: 'C 級', label: 'C', levelRange: [40, 51] },
  { id: 4, name: 'B 級', label: 'B', levelRange: [52, 61] },
  { id: 5, name: 'A 級', label: 'A', levelRange: [62, 75] },
  { id: 6, name: 'S 級', label: 'S', levelRange: [76, 100] },
]);
