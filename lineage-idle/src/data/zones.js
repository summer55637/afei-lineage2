 ...
 */
export const SAGAS = [
  { id: 'interlude', name: '序章', level: 0, unlocksAt: 0, zones: ['talkingIsland', 'elvenForest', 'darkForest', 'orcVillage', 'dwarvenMine', 'kamaelLair', 'ruinedOutpost', 'howlingMoor'] },
  { id: 'prelude', name: '戰爭前奏', level: 1, unlocksAt: 20, zones: ['giranOutskirts', 'orcenRuins', 'forsakenCrypt', 'blackCitadel'] },
  { id: 'saga1', name: '史詩 I：覺醒', level: 2, unlocksAt: 40, zones: ['gludioCastle', 'wolfMountain', 'riftOfTheVoid', 'emeraldGrove', 'underworldGate', 'valleyOfSaints', 'swampOfScreams'] },
  { id: 'sevensigns', name: '七封印：地下墓穴與死靈墓園', level: 3, unlocksAt: 30, zones: ['necro_sacrifice', 'necro_pilgrim', 'necro_worship', 'necro_patriot', 'necro_ascetics', 'necro_martyrs', 'necro_apostles', 'necro_disciple'] },
  { id: 'saga2', name: '史詩 II：暗影', level: 4, unlocksAt: 76, zones: ['adenCity', 'dragonValley'] },
  { id: 'saga3', name: '史詩 III：諸神領域', level: 5, unlocksAt: 85, zones: ['imperialTomb', 'antharasLair', 'forgeOfGods'] }
];
...
export const ZONES = {
  ...
  orcVillage:      { name: '半獸人村', level: 7, monsters: ['orc', 'kashaWolf', 'kashaBear', 'kashaOrcArcher', 'kashaOrcBerserker'], boss: 'kashaOrcOverlord', shop: 'talkingIsland' },
  ...
  ruinedOutpost:   { name: '廢棄前哨站', level: 15, monsters: ['ruinedGoblinThief', 'ruinedOrc', 'outpostMarksman', 'ruinedDeserter', 'shadowMercenary'], boss: 'outpostFallenCaptain', shop: 'talkingIsland', town: false },
  ...
  orcenRuins:      { name: '歐肯遺跡', level: 30, monsters: ['orcenRuinsOrc', 'cursedWarrior', 'ruinShamanOrc', 'tombLooterOrc', 'ancientOrcExecutioner'], boss: 'orcenOverlord', shop: 'giranOutskirts' },
  ...
  blackCitadel:    { name: '黑暗要塞', level: 40, monsters: ['deathKnight', 'deathWizard', 'citadelDarkPriest', 'blackDragonWhelp', 'blackDragon'], boss: 'flamingDemonLord', shop: 'dragonValley', town: true },
  ...
  wolfMountain:    { name: '狼山', level: 48, monsters: ['mountainWolf', 'mountainDireWolf', 'frostStalkerWolf', 'mountainSnowBear', 'frostFangBehemoth'], boss: 'mountainAlphaWolf', shop: 'gludioCastle' },
  riftOfTheVoid:   { name: '虛空裂隙', level: 50, monsters: ['voidCreature', 'voidBrute', 'voidStalker', 'beholder', 'voidArchonEntity'], boss: 'voidDragonLord', shop: 'dragonValley', town: false },
  emeraldGrove:    { name: '翡翠林地', level: 60, monsters: ['emeraldSnake', 'emeraldDrake', 'jadeGolem', 'groveSpiritMage', 'emeraldDragon'], boss: 'fafurion', shop: 'dragonValley', town: false },
  ...
  // ═══════════════════════════════════════════════════════════════════════
  necro_sacrifice: { name: '祭品的墓地', level: 32, monsters: ['necro_lilim_butcher', 'necro_nephilim_sentinel', 'necro_tomb_priest'], boss: 'necro_sacrifice_boss', shop: 'giranOutskirts', town: false },
  necro_pilgrim:   { name: '朝聖者的墓地', level: 42, monsters: ['necro_lilim_assassin', 'necro_nephilim_guard', 'necro_crypt_shaman'], boss: 'necro_pilgrim_boss', shop: 'gludioCastle', town: false },
  necro_worship:   { name: '禮拜者的墓地', level: 52, monsters: ['necro_gargoyle_watcher', 'necro_lilim_magus', 'necro_dusk_templar'], boss: 'necro_worship_boss', shop: 'gludioCastle', town: false },
  necro_patriot:   { name: '愛國者的墓地', level: 62, monsters: ['necro_patriot_berserker', 'necro_patriot_bishop', 'necro_patriot_drake'], boss: 'necro_patriot_boss', shop: 'dragonValley', town: false },
  necro_ascetics:  { name: '苦行者的地下墓穴', level: 72, monsters: ['necro_ascetic_slayer', 'necro_ascetic_crusader', 'necro_ascetic_seer'], boss: 'necro_ascetic_boss', shop: 'adenCity', town: false },
  necro_martyrs:   { name: '殉教者的地下墓穴', level: 76, monsters: ['necro_martyr_dreadnought', 'necro_martyr_sorcerer', 'necro_martyr_gargoyle'], boss: 'necro_martyr_boss', shop: 'adenCity', town: false },
  necro_apostles:  { name: '使徒的地下墓穴', level: 80, monsters: ['necro_apostle_vanguard', 'necro_apostle_hierophant', 'necro_apostle_behemoth'], boss: 'necro_apostle_boss', shop: 'adenCity', town: false },
  necro_disciple:  { name: '門徒的墓地', level: 84, monsters: ['necro_disciple_knight', 'necro_disciple_sorceress', 'necro_disciple_executioner'], boss: 'necro_disciple_boss', shop: 'adenCity', town: false }
};
