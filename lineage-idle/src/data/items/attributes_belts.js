...
export const LIFE_STONE_ITEMS = {
  lifestone_common: { id: 'lifestone_common', name: '普通生命石 💎', grade: 'common', slot: 'material', type: 'lifestone', tier: 3, rarity: 'rare', price: 50000, icon: 'materials/crystal_blue_d.png', desc: '用於武器 Augmentation 的基礎生命石。' },
  lifestone_mid: { id: 'lifestone_mid', name: '中級生命石 💎', grade: 'mid', slot: 'material', type: 'lifestone', tier: 4, rarity: 'epic', price: 150000, icon: 'materials/bluem_gemstone.png', desc: '用於 Augmentation，較容易獲得額外屬性。' },
  lifestone_high: { id: 'lifestone_high', name: '高級生命石 💎', grade: 'high', slot: 'material', type: 'lifestone', tier: 5, rarity: 'legendary', price: 400000, icon: 'materials/crystal_red_b.png', desc: '具有較高機率獲得 Item Skill。' },
  lifestone_top: { id: 'lifestone_top', name: '最高級生命石 💎', grade: 'top', slot: 'material', type: 'lifestone', tier: 6, rarity: 'sovereign', price: 1000000, icon: 'materials/crystal_gold_s.png', desc: '最高級生命石，具有 40% 光澤機率與 25% 史詩 Item Skill 機率。' }
};
...
export const BELT_ITEMS = {
  ...
  belt_leather: { id: 'belt_leather', name: '皮革腰帶［D 級］', slot: 'belt', tier: 2, rarity: 'rare', price: 25000, icon: 'graded/armors/armor_brigandine_belt.png', desc: '強化皮革腰帶。負重上限 +1000、P.Def +10。' },
  belt_iron: { id: 'belt_iron', name: '鐵製腰帶［C 級］', slot: 'belt', tier: 3, rarity: 'epic', price: 75000, icon: 'gradec/armors/armor_full_plate_belt.png', desc: '鑲鐵腰帶。負重上限 +1500、P.Def +20。' },
  belt_mithril: { id: 'belt_mithril', name: '米索莉腰帶［B 級］', slot: 'belt', tier: 4, rarity: 'epic', price: 200000, icon: 'gradeb/armors/armor_blue_wolf_belt.png', desc: '附魔米索莉腰帶。負重上限 +2000、P.Def +35。' },
...
export const SUPERIOR_LIFE_STONE_AUGMENTS = [
  { id: 'might', name: '物品技能：力量', desc: 'P.Atk +8%（一般 PvE）。', pAtkMult: 0.08 },
  { id: 'empower', name: '物品技能：魔力強化', desc: 'M.Atk +15%（一般 PvE）。', mAtkMult: 0.15 },
  { id: 'shield', name: '物品技能：盾牌', desc: 'P.Def +10%（一般 PvE）。', pDefMult: 0.10 },
  { id: 'magicBarrier', name: '物品技能：魔法屏障', desc: 'M.Def +12%（一般 PvE）。', mDefMult: 0.12 },
  { id: 'focus', name: '物品技能：專注', desc: 'P.Crit.Rate +50 點。', critRateAdd: 50 },
  { id: 'wildMagic', name: '物品技能：野性魔力', desc: 'M.Crit.Rate +4 點。', mCritAdd: 4 },
  { id: 'vampiricRage', name: '物品技能：吸血狂怒', desc: 'Vampiric Rage +6%。', lifestealAdd: 0.06 }
];