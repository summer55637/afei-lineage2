...
{ name: "席琳聖殿騎士和諧", type: "Self-Buff", rarity: "4★", effect: "+55% DEF, +40% 最大 HP, +30% 黑暗 傷害 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
  ...
  bladeDancer: {
    ...
    skills: [
      ...
      { name: "神秘之舞",        type: "Party-Buff", rarity: "2★", effect: "+20% 魔法攻擊給o 隊伍", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
  ...
  shillienElder: {
    ...
    skills: [
      ...
      { name: "魔力強化",          type: "Party-Buff", rarity: "2★", effect: "+20% 魔法攻擊給o 隊伍", cooldown: "30s", duration: "300s", note: "轉職後技能仍會保留" },
      ...
      { name: "精神之盾",    type: "Party-Buff", rarity: "2★", effect: "+15% 魔法防禦給o 隊伍", cooldown: "30s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "席琳烙印", type: "Ativo",   rarity: "3★", effect: "標記目標: receb並 +25% 傷害 持續 10 秒", cooldown: "30s", duration: "10s", note: "轉職後技能仍會保留" },
      { name: "水之預言", type: "Party-Buff", rarity: "3★", effect: "+15% 魔法攻擊, +10% 施法速度, +10% 魔法防禦給o 隊伍", cooldown: "60s", duration: "600s", note: "轉職後技能仍會保留" },
  ...
  shillienSaint: {
    ...
    skills: [
      ...
      { name: "黑暗面",                   type: "Toggle",   rarity: "3★", effect: "ON: -50% 治癒, +80% 魔法攻擊 黑暗, skills mudam給ofensivo", cooldown: "10s toggle", duration: "Toggle", note: "轉職後技能仍會保留" },
  ...
  sayhaMageBase: {
    ...
    skills: [
      ...
      { name: "艾爾提亞魔法精通",        type: "Passivo",   rarity: "1★", effect: "+15% 魔法攻擊 搭配 Cajados", cooldown: null },
