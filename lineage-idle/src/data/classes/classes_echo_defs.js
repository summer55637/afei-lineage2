...
const RACES_ECHO = {
  ...
  orc:      { name: '半獸人',       desc: '體魄強韌，擁有強大力量與高 生命值。',             stats: { atk: 4,  def: 6,  eva:-4,  matk:-2,  mdef:-2 }, startZone: 'talkingIsland' },
...
const CLASSES_ECHO = {
  ...
  fighter: {
    ...
    skills: [
      ...
      { name: "包紮",             type: "Ativo",    rarity: "1★", effect: "治癒 15% 生命值",                   cooldown: "30s",    desc: "進行緊急治療。" },
      { name: "戰士意志",      type: "Self-Buff",rarity: "1★", effect: "+10% 攻擊力 並 +10% 防禦力 持續 15 分鐘",cooldown: "30 min", desc: "戰士堅定的意志。" },
      { name: "生命值提升（等級1）",     type: "Passivo",  rarity: "1★", effect: "+5% 最大生命值",                    cooldown: "N/A",    desc: "強化體質。" },
      { name: "輕甲精通", type: "Passivo",  rarity: "1★", effect: "+8% 防禦力 裝備輕甲時",     cooldown: "N/A",    desc: "精通輕型防具。" }
    ]
  },
  ...
  warrior: {
    ...
    skills: [
      ...
      { name: "鋼鐵意志",             type: "Ativo",    rarity: "2★", effect: "+30% 防禦力 持續 30 秒",                    cooldown: "45s",    desc: "暫時獲得鋼鐵般的意志。" },
      { name: "戰吼",               type: "Ativo",    rarity: "2★", effect: "+20% 攻擊力 自身 持續 60 秒",            cooldown: "60s",    desc: "激發力量的戰鬥吶喊。" },
      { name: "戰鬥咆哮",           type: "Self-Buff",rarity: "2★", effect: "+25% 攻擊力 並 +15% 生命值 持續 20 分鐘",       cooldown: "45 min", desc: "發出戰鬥咆哮。" },
      { name: "劍／鈍器精通",   type: "Passivo",  rarity: "1★", effect: "+12% 攻擊力 使用劍／鈍器時",           cooldown: "N/A",    desc: "精通劍與鈍器。" },
      { name: "長柄武器精通",       type: "Passivo",  rarity: "1★", effect: "+12% 攻擊力 使用長柄武器時",                cooldown: "N/A",    desc: "精通長槍與長柄武器。" },
      { name: "重甲精通",   type: "Passivo",  rarity: "1★", effect: "+12% 防禦力 裝備重甲時",        cooldown: "N/A",    desc: "精通重型防具。" },
      { name: "生命值提升（等級2）",       type: "Passivo",  rarity: "1★", effect: "+10% 最大生命值",                         cooldown: "N/A",    desc: "強化戰士體質。" },
  ...
  gladiator: {
    ...
    skills: [
      ...
      { name: "兇猛姿態",         type: "Toggle",   rarity: "2★", effect: "+25% 暴擊率, -10% 防禦力",           cooldown: "N/A",    desc: "持續維持積極進攻姿態。" },
      { name: "角鬥士和諧",    type: "Self-Buff",rarity: "3★", effect: "+35% 攻擊力 並 +20% 暴擊 持續 25 分鐘",    cooldown: "60 min", desc: "角鬥士的戰鬥和諧。" },
      { name: "雙武器精通",    type: "Passivo",  rarity: "2★", effect: "+18% 攻擊力 使用雙持武器時",          cooldown: "N/A",    desc: "精通雙持武器。" },
      ...
      { name: "生命值強化",               type: "Passivo",  rarity: "1★", effect: "+12% 最大生命值",                        cooldown: "N/A",    desc: "強化角鬥士的 生命值。" }
    ]
  },
  ...
  duelist: {
    ...
    skills: [
      { name: "音速聚氣",               type: "Ativo",    rarity: "3★", effect: "傷害 380% + 無視 30% 防禦力",           cooldown: "28s",    desc: "凝聚毀滅性的音速力量。" },
      ...
      { name: "戰鬥激情",              type: "Ativo",    rarity: "3★", effect: "+40% 攻擊力 持續 30 秒 當 生命值 < 30%",     cooldown: "120s",   desc: "在危急狀態下激發腎上腺素。" },
      { name: "音速狂怒",                type: "Ativo",    rarity: "3★", effect: "傷害 450% + 範圍 5 目標",             cooldown: "30s",    desc: "釋放失控的音速狂怒。" },
      { name: "超越雙重打擊",    type: "Ativo",    rarity: "4★", effect: "傷害 620% + 流血 12 秒 + 無視 防禦力",   cooldown: "150s",   desc: "施展超越極限的雙重打擊。" },
      { name: "決鬥者",         type: "Self-Buff",rarity: "4★", effect: "+55% 攻擊力, +40% 暴擊, +20% 速度 30 分鐘",cooldown: "90 min", desc: "決鬥者的至高戰鬥和諧。" },
      { name: "戰鬥大師",          type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +10% 暴擊, +5% 對怪物 傷害",    cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
  ...
  warlord: {
    ...
    skills: [
      ...
      { name: "咆哮",                   type: "Ativo",    rarity: "2★", effect: "範圍 嘲諷 + -15% 攻擊力 敵人 10 秒",  cooldown: "20s",    desc: "發出具有威嚇效果的咆哮。" },
      ...
      { name: "戰吼",               type: "Self-Buff",rarity: "2★", effect: "+25% 攻擊力 持續 60 秒",                    cooldown: "90s",    desc: "戰爭領主的戰鬥吶喊。" },
      { name: "戰爭領主和諧",     type: "Self-Buff",rarity: "3★", effect: "+30% 攻擊力, +25% 生命值 持續 25 分鐘",        cooldown: "60 min", desc: "戰爭領主的戰鬥和諧。" },
      { name: "生命之力",           type: "Passivo",  rarity: "1★", effect: "+10% 生命值恢復",                       cooldown: "N/A",    desc: "強化生命恢復能力。" },
      { name: "專注",                 type: "Passivo",  rarity: "1★", effect: "+8% 暴擊率",                       cooldown: "N/A",    desc: "提升專注力。" },
      { name: "生命值強化",              type: "Passivo",  rarity: "1★", effect: "+15% 最大生命值",                         cooldown: "N/A",    desc: "強化 生命值。" }
    ]
  },
  ...
  dreadnought: {
    ...
    skills: [
      ...
      { name: "刺擊",                     type: "Ativo",    rarity: "3★", effect: "傷害 380% + 穿透 防禦力 40%",             cooldown: "28s",    desc: "施展具有穿透力的刺擊。" },
      ...
      { name: "恐懼戰艦和諧",     type: "Self-Buff",rarity: "4★", effect: "+50% 攻擊力, +35% 生命值, +20% 防禦力 30 分鐘",      cooldown: "90 min", desc: "恐懼戰艦的戰鬥和諧。" },
      { name: "戰鬥大師",          type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +10% 範圍 傷害, +5% 對怪物",        cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      { name: "恐懼戰艦之魂",        type: "Passivo",  rarity: "3★", effect: "+15% 長柄武器攻擊",                        cooldown: "N/A",    desc: "恐懼戰艦的戰鬥精神。" },
      { name: "恐懼戰艦之軀",   type: "Passivo",  rarity: "3★", effect: "+10% 最大生命值, +10% 防禦力",                  cooldown: "N/A",    desc: "獲得近乎無法摧毀的身軀。" }
    ]
  },
  ...
  knight: {
    ...
    skills: [
      ...
      { name: "力量削弱",           type: "Ativo",    rarity: "1★", effect: "傷害 150% + -20% 攻擊力 敵人 8 秒",  cooldown: "14s",    desc: "削弱敵人的力量。" },
      { name: "神聖治癒",           type: "Ativo",    rarity: "2★", effect: "治癒 20% 生命值 自身",              cooldown: "25s",    desc: "以神聖力量治療自己。" },
      { name: "騎士和諧",      type: "Self-Buff",rarity: "2★", effect: "+25% 防禦力 並 +20% 生命值 持續 20 分鐘",    cooldown: "45 min", desc: "騎士的戰鬥和諧。" },
      { name: "重甲精通",   type: "Passivo",  rarity: "1★", effect: "+15% 防禦力 裝備重甲時",     cooldown: "N/A",    desc: "精通重型防具。" },
      { name: "盾牌精通",        type: "Passivo",  rarity: "1★", effect: "+15% 格擋率",                  cooldown: "N/A",    desc: "精通盾牌防禦。" },
      { name: "劍／鈍器精通",   type: "Passivo",  rarity: "1★", effect: "+10% 攻擊力 劍／鈍器",            cooldown: "N/A",    desc: "精通劍類武器。" },
      { name: "生命值提升（等級2）",       type: "Passivo",  rarity: "1★", effect: "+12% 最大生命值",                      cooldown: "N/A",    desc: "進一步強化體質。" },
  ...
  paladin: {
    ...
    skills: [
      ...
      { name: "威嚴",               type: "Ativo",    rarity: "3★", effect: "7 秒內不會死亡（生命值 最低保留 1）",cooldown: "180s",  desc: "獲得神聖威嚴。" },
      { name: "天使聖像",          type: "Self-Buff",rarity: "3★", effect: "+30% 防禦力, +30% 魔法防禦 持續 30 秒",    cooldown: "120s",   desc: "召喚天使般的神聖力量。" },
      { name: "犧牲",             type: "Ativo",    rarity: "2★", effect: "治癒盟友 30% 生命值 (消耗 10% 自身)",cooldown: "25s",desc: "犧牲自身力量守護盟友。" },
      ...
      { name: "終極防禦",      type: "Ativo",    rarity: "3★", effect: "+80% 防禦力, -50% 攻擊力 持續 15 秒",      cooldown: "120s",   desc: "進入近乎絕對的防禦狀態。" },
      ...
      { name: "聖騎士和諧",     type: "Self-Buff",rarity: "3★", effect: "+40% 防禦力, +30% 生命值, +20% 魔法防禦 25 分鐘",cooldown: "60 min",desc: "聖騎士的戰鬥和諧。" },
      { name: "神聖／黑暗抗性",      type: "Passivo",  rarity: "2★", effect: "+15% 抗性 神聖/黑暗",           cooldown: "N/A",    desc: "提高神聖與黑暗屬性抗性。" },
      { name: "生命值強化",              type: "Passivo",  rarity: "2★", effect: "+18% 最大生命值",                     cooldown: "N/A",    desc: "擴充最大 生命值。" }
    ]
  },
  ...
  phoenixKnight: {
    ...
    skills: [
      { name: "生命之觸",                type: "Ativo",    rarity: "3★", effect: "治癒 範圍 25% 生命值 (隊伍)",               cooldown: "35s",    desc: "施展鳳凰的生命之觸。" },
      { name: "鳳凰光環",                 type: "Self-Buff",rarity: "3★", effect: "+45% 防禦力, +生命值恢復 3%/s 持續 25 分鐘",    cooldown: "60 min", desc: "釋放鳳凰之力形成光環。" },
      { name: "信仰之盾",              type: "Ativo",    rarity: "3★", effect: "吸收 5000 傷害 持續 15 秒",             cooldown: "90s",    desc: "以信仰之力展開護盾。" },
      { name: "烈焰聖像",                   type: "Ativo",    rarity: "3★", effect: "隊伍 攻擊力 +35%，持續 30 秒",           cooldown: "120s",   desc: "召喚烈焰之力。" },
      ...
      { name: "鳳凰騎士和諧",     type: "Self-Buff",rarity: "4★", effect: "+60% 防禦力, +40% 生命值, +30% 魔法防禦 30 分鐘",  cooldown: "90 min", desc: "鳳凰騎士的至高戰鬥和諧。" },
      { name: "鳳凰之魂",            type: "Passivo",  rarity: "4★", effect: "死亡時以 30% 生命值 復活（每 30 分鐘 1 次）",cooldown: "N/A",   desc: "鳳凰之魂可賦予自動復活能力。" },
      { name: "戰鬥大師",             type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +15% 仇恨, +5% 對怪物",        cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      { name: "信仰守護",          type: "Passivo",  rarity: "3★", effect: "+12% 抗性 全",                      cooldown: "N/A",    desc: "以信仰之力獲得守護。" },
      { name: "鳳凰之軀",          type: "Passivo",  rarity: "3★", effect: "+15% 最大生命值, +10% 防禦力",                cooldown: "N/A",    desc: "獲得鳳凰般強韌的身軀。" }
    ]
  },
  ...
  darkAvenger: {
    ...
    skills: [
      { name: "召喚黑暗豹",    type: "Ativo",    rarity: "3★", effect: "召喚 黑豹 (攻擊力 60% 主人)",    cooldown: "90s",    desc: "召喚黑暗豹協助戰鬥。" },
      { name: "生命吸取",           type: "Ativo",    rarity: "2★", effect: "傷害 220% + 吸取 30%為 生命值",      cooldown: "15s",    desc: "吸取敵人的生命力。" },
      ...
      { name: "審判",               type: "Ativo",    rarity: "3★", effect: "傷害 黑暗 300% + -20% 防禦力 10 秒",     cooldown: "22s",    desc: "施展黑暗審判。" },
      ...
      { name: "黑暗復仇者和諧", type: "Self-Buff",rarity: "3★", effect: "+35% 攻擊力, +30% 防禦力, +20% 吸取 25 分鐘",cooldown: "60 min",desc: "黑暗復仇者的戰鬥和諧。" },
      { name: "傷害反射",         type: "Passivo",  rarity: "2★", effect: "反射 8% 傷害 受到的",          cooldown: "N/A",    desc: "反射受到的部分傷害。" },
      { name: "生命值強化",               type: "Passivo",  rarity: "2★", effect: "+16% 最大生命值",                       cooldown: "N/A",    desc: "強化 生命值。" }
    ]
  },
  ...
  hellKnight: {
    ...
    skills: [
      ...
      { name: "地獄頌歌",               type: "Self-Buff",rarity: "3★", effect: "+40% 攻擊力, +20% 吸取 生命值 持續 30 秒",        cooldown: "90s",    desc: "吟唱地獄的戰鬥頌歌。" },
      ...
      { name: "召喚強化黑暗豹",  type: "Ativo",    rarity: "4★", effect: "黑豹 強化 (攻擊力 80% 主人)",   cooldown: "120s",   desc: "召喚經過強化的黑暗豹。" },
      { name: "超越黑暗打擊",     type: "Ativo",    rarity: "4★", effect: "傷害 580% 黑暗 + 吸取 40%為 生命值",     cooldown: "150s",   desc: "施展超越極限的黑暗打擊。" },
      { name: "地獄騎士和諧",        type: "Self-Buff",rarity: "4★", effect: "+55% 攻擊力, +40% 防禦力, +30% 吸取 30 分鐘",   cooldown: "90 min", desc: "地獄騎士的戰鬥和諧。" },
      { name: "戰鬥大師",             type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +10% 吸取, +5% 對怪物",         cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      { name: "地獄騎士之魂",           type: "Passivo",  rarity: "3★", effect: "+15% 黑暗 攻擊力",                          cooldown: "N/A",    desc: "地獄騎士的戰鬥精神。" },
      { name: "地獄騎士之軀",      type: "Passivo",  rarity: "3★", effect: "+12% 最大生命值, +10% 防禦力",                 cooldown: "N/A",    desc: "獲得地獄騎士般強韌的身軀。" },
  ...
  rogue: {
    ...
    skills: [
      ...
      { name: "匕首精通",       type: "Passivo",  rarity: "1★", effect: "+12% 攻擊力 使用匕首時",              cooldown: "N/A",    desc: "精通匕首武器。" },
      { name: "弓精通",          type: "Passivo",  rarity: "1★", effect: "+12% 攻擊力 使用弓時",                cooldown: "N/A",    desc: "精通弓類武器。" },
  ...
  treasureHunter: {
    ...
    skills: [
      ...
      { name: "寶藏獵人和諧",          type: "Self-Buff",rarity: "3★", effect: "+35% 暴擊, +25% 迴避, +20% 攻擊力 25 分鐘", cooldown: "60 min", desc: "寶藏獵人的戰鬥和諧。" },
  ...
  adventurer: {
    ...
    skills: [
      { name: "刺激冒險",          type: "Self-Buff",rarity: "3★", effect: "+45% 迴避, +30% 暴擊, +20% 攻擊力 20 分鐘",  cooldown: "55 min", desc: "進入充滿刺激感的戰鬥狀態。" },
      ...
      { name: "冒險家和諧",        type: "Self-Buff",rarity: "4★", effect: "+55% 暴擊, +45% 迴避, +35% 攻擊力 30 分鐘",  cooldown: "90 min", desc: "冒險家的至高戰鬥和諧。" },
      { name: "戰鬥大師",            type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +10% 暴擊, +5% 對怪物",         cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      ...
      { name: "冒險家之軀",      type: "Passivo",  rarity: "3★", effect: "+10% 最大生命值, +8% 迴避",                 cooldown: "N/A",    desc: "獲得靈活敏捷的身軀。" },
      { name: "最終狂熱",                type: "Passivo",  rarity: "3★", effect: "+25% 攻擊力 當 生命值 < 30%",              cooldown: "N/A",    desc: "在危急狀態下進入最終狂熱。" }
    ]
  },
  ...
  hawkeye: {
    ...
    skills: [
      ...
      { name: "鷹眼和諧",     type: "Self-Buff",rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +15% 射程 25 分鐘",cooldown: "60 min",desc: "鷹眼的戰鬥和諧。" },
      { name: "弓精通",           type: "Passivo",  rarity: "2★", effect: "+18% 攻擊力 使用弓時",                  cooldown: "N/A",    desc: "精通弓類武器。" },
  ...
  sagittarius: {
    ...
    skills: [
      ...
      { name: "死亡之眼",                     type: "Self-Buff",rarity: "3★", effect: "+50% 攻擊力, +40% 射程 持續 20 分鐘",         cooldown: "55 min", desc: "進入完美瞄準狀態。" },
      { name: "精準射擊",                type: "Ativo",    rarity: "3★", effect: "傷害 400% + 無視 50% 防禦力",             cooldown: "28s",    desc: "對要害施展精準射擊。" },
      ...
      { name: "超越七連矢",     type: "Ativo",    rarity: "4★", effect: "傷害 700% + 元素 + 無視 防禦力",     cooldown: "180s",   desc: "施展超越極限的七連箭攻擊。" },
      { name: "射手座和諧",         type: "Self-Buff",rarity: "4★", effect: "+60% 攻擊力, +50% 暴擊, +40% 射程 30 分鐘",  cooldown: "90 min", desc: "射手座的戰鬥和諧。" },
      { name: "戰鬥大師",             type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +10% 射程, +5% 對怪物",         cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      { name: "射手之魂",            type: "Passivo",  rarity: "3★", effect: "+15% 弓攻擊",                           cooldown: "N/A",    desc: "射手座的戰鬥精神。" },
      { name: "射手之軀",       type: "Passivo",  rarity: "3★", effect: "+10% 最大生命值, +8% 迴避",                  cooldown: "N/A",    desc: "獲得射手般靈活的身軀。" }
    ]
  },
  ...
  mage: {
    ...
    skills: [
      ...
      { name: "自我治癒",         type: "Ativo",    rarity: "1★", effect: "治癒 20% 生命值",                  cooldown: "25s",    desc: "進行基礎自我治療。" },
      ...
      { name: "魔力提升",       type: "Passivo",  rarity: "1★", effect: "+8% 最大魔力",                   cooldown: "N/A",    desc: "提高魔力儲備。" }
    ]
  },
  ...
  wizard: {
    ...
    skills: [
      ...
      { name: "生命吸取",            type: "Ativo",    rarity: "2★", effect: "傷害 黑暗 190% + 吸取 25%為 生命值",cooldown: "15s",    desc: "吸取目標生命力。" },
      ...
      { name: "魔力強化",            type: "Passivo",  rarity: "1★", effect: "+12% 最大魔力",                       cooldown: "N/A",    desc: "進一步強化魔力儲備。" }
    ]
  },
  ...
  sorcerer: {
    ...
    skills: [
      ...
      { name: "身心轉換",          type: "Ativo",    rarity: "2★", effect: "將 15% 生命值 轉換為 30% 魔力",           cooldown: "30s",    desc: "將生命力轉換為魔力。" },
  ...
  archmage: {
    ...
    skills: [
      ...
      { name: "魔力燃燒",                     type: "Ativo",    rarity: "2★", effect: "吸取目標 30% 魔力，並造成等同吸取 魔力 的傷害", cooldown: "25s",    desc: "燃燒目標的魔力。" },
      ...
      { name: "大法師和諧",            type: "Self-Buff",rarity: "4★", effect: "+55% 魔法攻擊, +35% 施法速度, +20% 魔力 30 分鐘",cooldown: "90 min",desc: "大法師的戰鬥和諧。" },
      ...
      { name: "大法師之軀",           type: "Passivo",  rarity: "3★", effect: "+10% 最大魔力, +8% 魔法防禦",                 cooldown: "N/A",    desc: "以奧術力量強化身軀。" }
    ]
  },
  ...
  necromancer: {
    ...
    skills: [
      { name: "死亡尖刺",           type: "Ativo",    rarity: "2★", effect: "傷害 黑暗 260% + 吸取 25% 生命值",       cooldown: "12s",    desc: "召喚致命尖刺攻擊敵人。" },
      { name: "屍體瘟疫",          type: "Ativo",    rarity: "2★", effect: "範圍 黑暗 280% + 中毒 10 秒",          cooldown: "20s",    desc: "以屍體散播瘟疫。" },
      { name: "吸血鬼之爪",         type: "Ativo",    rarity: "2★", effect: "傷害 240% + 吸取 35% 生命值",            cooldown: "14s",    desc: "以吸血鬼之爪汲取生命。" },
      { name: "黑暗束縛",                type: "Ativo",    rarity: "2★", effect: "定身在目標 6 秒 + 傷害 180%",         cooldown: "22s",    desc: "以黑暗力量束縛目標。" },
      { name: "詛咒：幽暗",          type: "Ativo",    rarity: "2★", effect: "使目標 攻擊力 與魔法攻擊 -25%，持續 12 秒",        cooldown: "25s",    desc: "施加幽暗詛咒。" },
      { name: "屍爆",          type: "Ativo",    rarity: "3★", effect: "引爆屍體: 範圍 350% 黑暗",      cooldown: "25s",    desc: "引爆屍體造成傷害。" },
      { name: "召喚復生者", type: "Ativo",    rarity: "2★", effect: "召喚 不死生物 (攻擊力 50% 主人)", cooldown: "60s",    desc: "召喚復生的不死生物。" },
      { name: "召喚詛咒骨骸",    type: "Ativo",    rarity: "2★", effect: "召喚 骷髏 (攻擊力 40% 主人)",  cooldown: "45s",    desc: "召喚被詛咒的骨骸。" },
      ...
      { name: "死靈法師和諧",       type: "Self-Buff",rarity: "3★", effect: "+30% 魔法攻擊, +20% 吸取, +15% 生命值 25 分鐘",cooldown: "60 min",desc: "死靈法師的戰鬥和諧。" },
      { name: "骨之鎧甲",            type: "Passivo",  rarity: "2★", effect: "+15% 防禦力, +10% 黑暗 抗性",          cooldown: "N/A",    desc: "以骨骼形成護甲。" }
    ]
  },
  ...
  soultaker: {
    ...
    skills: [
      ...
      { name: "靈魂漩渦毀滅",       type: "Ativo",    rarity: "4★", effect: "傷害 黑暗 範圍 650% + 吸取 30% 生命值",        cooldown: "160s",   desc: "引爆靈魂漩渦造成毀滅傷害。" },
      { name: "虛空爆炸",                type: "Ativo",    rarity: "4★", effect: "傷害 黑暗 700% + 2 次命中 + 沉默 5 秒",     cooldown: "180s",   desc: "引發虛空能量爆炸。" },
      { name: "群體詛咒：幽暗",             type: "Ativo",    rarity: "3★", effect: "範圍 -30% 攻擊力/魔法攻擊 (8 目標) 12 秒",         cooldown: "35s",    desc: "對範圍敵人施加幽暗詛咒。" },
      { name: "靈魂吸收",               type: "Ativo",    rarity: "3★", effect: "吸取目標 40% 魔力 並轉為自身 魔力",     cooldown: "30s",    desc: "吸收敵人的靈魂力量。" },
      { name: "召喚黑暗詛咒",             type: "Ativo",    rarity: "3★", effect: "召喚 實體 黑暗 (攻擊力 70% 主人)",    cooldown: "90s",    desc: "召喚具有生命的黑暗詛咒。" },
      { name: "黑暗負擔",                   type: "Ativo",    rarity: "3★", effect: "-40% 速度在目標 10 秒 + 傷害 300%",       cooldown: "28s",    desc: "使目標承受黑暗負擔。" },
      { name: "超越靈魂漩渦",      type: "Ativo",    rarity: "4★", effect: "黑暗傷害 850% + 吸取全部 魔力 + 暈眩 4 秒", cooldown: "200s",   desc: "施展超越極限的靈魂漩渦。" },
      { name: "奪魂者和諧",           type: "Self-Buff",rarity: "4★", effect: "+55% 魔法攻擊, +40% 吸取, +25% 生命值 30 分鐘",    cooldown: "90 min", desc: "奪魂者的戰鬥和諧。" },
      ...
      { name: "奪魂者之軀",         type: "Passivo",  rarity: "3★", effect: "+12% 最大魔力, +10% 生命值",                    cooldown: "N/A",    desc: "強化奪魂者的身軀。" }
    ]
  },
  ...
  warlock: {
    ...
    skills: [
      { name: "召喚暗影",          type: "Ativo",    rarity: "2★", effect: "召喚 暗影 (攻擊力 45% 主人)",     cooldown: "60s",    desc: "召喚戰鬥型暗影。" },
      { name: "召喚魅影",      type: "Ativo",    rarity: "2★", effect: "召喚幻影（坦克型，防禦力 60%）",     cooldown: "60s",    desc: "召喚防禦型魅影。" },
      { name: "召喚無魂者",        type: "Ativo",    rarity: "3★", effect: "召喚 無魂者 (攻擊力 65% 主人)",   cooldown: "90s",    desc: "召喚強力的無魂生物。" },
      { name: "召喚獸治癒",          type: "Ativo",    rarity: "2★", effect: "治癒召喚物 35% 生命值",                  cooldown: "12s",    desc: "治療召喚獸。" },
      { name: "召喚獸回復",      type: "Ativo",    rarity: "2★", effect: "恢復召喚物 30% 魔力",           cooldown: "15s",    desc: "恢復召喚獸的魔力。" },
      ...
      { name: "召喚術士和諧",      type: "Self-Buff",rarity: "3★", effect: "+30% 魔法攻擊, +25% 召喚物 攻擊力 25 分鐘",   cooldown: "60 min", desc: "召喚術士的戰鬥和諧。" },
      { name: "召喚獸物理攻擊",  type: "Passivo",  rarity: "2★", effect: "+15% 召喚物 攻擊力",                     cooldown: "N/A",    desc: "提高召喚獸的物理攻擊能力。" }
    ]
  },
  ...
  arcanaLord: {
    ...
    skills: [
      { name: "召喚貓王",            type: "Ativo",    rarity: "4★", effect: "召喚貓王（攻擊力 為主人 90%）",       cooldown: "120s",   desc: "召喚至高的貓族之王。" },
      { name: "召喚馬格努斯",                 type: "Ativo",    rarity: "3★", effect: "召喚瑪格努斯（範圍 攻擊力 為主人 70%）",       cooldown: "90s",    desc: "召喚元素生物馬格努斯。" },
      { name: "召喚獸屏障",              type: "Ativo",    rarity: "3★", effect: "召喚物 獲得護盾 5000 生命值 持續 15 秒",       cooldown: "60s",    desc: "為召喚獸展開防護屏障。" },
      { name: "群體召喚獸治癒",            type: "Ativo",    rarity: "3★", effect: "治癒所有召喚物 40% 生命值",                cooldown: "25s",    desc: "治療多個召喚獸。" },
      { name: "召喚獸強化",          type: "Self-Buff",rarity: "3★", effect: "+50% 召喚物 攻擊力/防禦力 持續 30 秒",               cooldown: "90s",    desc: "強化召喚獸的戰鬥能力。" },
      { name: "最終召喚獸",                type: "Ativo",    rarity: "4★", effect: "召喚物 犧牲: 範圍 600% + 治癒 50% 生命值",  cooldown: "180s",   desc: "犧牲召喚獸釋放最後力量。" },
      ...
      { name: "召喚大師",           type: "Passivo",  rarity: "3★", effect: "+15% 召喚物 攻擊力/防禦力, +5% 對怪物",             cooldown: "N/A",    desc: "精通召喚術。" },
      { name: "奧術領主之魂",            type: "Passivo",  rarity: "3★", effect: "+12% 魔法攻擊, +10% 召喚物 生命值",                cooldown: "N/A",    desc: "奧術領主的戰鬥精神。" },
      { name: "奧術領主之軀",       type: "Passivo",  rarity: "3★", effect: "+10% 最大魔力, +8% 最大生命值",                  cooldown: "N/A",    desc: "以奧術力量強化身軀。" }
    ]
  },
  ...
  cleric: {
    ...
    skills: [
      { name: "治癒",             type: "Ativo",    rarity: "1★", effect: "治癒 25% 生命值 目標",                 cooldown: "8s",     desc: "進行基礎治療。" },
      { name: "戰鬥治癒",      type: "Ativo",    rarity: "1★", effect: "治癒 20% 生命值 + 移除 1 減益",    cooldown: "10s",    desc: "在戰鬥中快速治療。" },
      { name: "力量",            type: "Party-Buff",rarity: "1★", effect: "隊伍 攻擊力 +15%，持續 10 分鐘",      cooldown: "25 min", desc: "賦予提升力量的祝福。" },
      { name: "盾牌祝福",    type: "Party-Buff",rarity: "1★", effect: "隊伍 防禦力 +15%，持續 10 分鐘",      cooldown: "25 min", desc: "賦予防護祝福。" },
      ...
      { name: "魔力回復",         type: "Ativo",    rarity: "1★", effect: "恢復目標 20% 魔力",          cooldown: "12s",    desc: "恢復目標的 魔力。" },
  ...
  bishop: {
    ...
    skills: [
      { name: "高級治癒",          type: "Ativo",      rarity: "2★", effect: "治癒 40% 生命值 目標",                    cooldown: "10s",    desc: "施展更強力的治療。" },
      { name: "高級群體治癒",    type: "Ativo",      rarity: "3★", effect: "治癒 30% 生命值 隊伍",                   cooldown: "18s",    desc: "治療隊伍成員。" },
      { name: "復活",          type: "Ativo",      rarity: "3★", effect: "以 30% 生命值 復活盟友",        cooldown: "120s",   desc: "使倒下的目標復活。" },
      { name: "高級力量",         type: "Party-Buff", rarity: "2★", effect: "+25% 攻擊力 隊伍 12 分鐘",               cooldown: "30 min", desc: "賦予更強大的力量祝福。" },
      { name: "高級盾牌",        type: "Party-Buff", rarity: "2★", effect: "+25% 防禦力 隊伍 12 分鐘",               cooldown: "30 min", desc: "賦予更強大的防護祝福。" },
      { name: "祝福之軀",          type: "Party-Buff", rarity: "2★", effect: "+20% 最大生命值 隊伍 12 分鐘",            cooldown: "30 min", desc: "以祝福強化身體。" },
      { name: "祝福之魂",          type: "Party-Buff", rarity: "2★", effect: "+20% 最大魔力 隊伍 12 分鐘",            cooldown: "30 min", desc: "以祝福強化靈魂。" },
      { name: "神聖武器",           type: "Party-Buff", rarity: "2★", effect: "+15% 神聖 攻擊力 隊伍 12 分鐘",          cooldown: "30 min", desc: "賦予武器神聖力量。" },
      ...
      { name: "大型治癒",            type: "Ativo",      rarity: "3★", effect: "治癒 55% 生命值 目標",                    cooldown: "15s",    desc: "施展強力治療。" },
      ...
      { name: "魔力再生",     type: "Passivo",    rarity: "2★", effect: "+15% 魔力恢復",                       cooldown: "N/A",    desc: "提高 魔力 自然恢復。" }
    ]
  },
  ...
  cardinal: {
    ...
    skills: [
      { name: "奇蹟",                      type: "Ativo",      rarity: "4★", effect: "治癒隊伍 80% 生命值 + 復活死亡成員",      cooldown: "300s",   desc: "施展至高治療並可復活盟友。" },
      { name: "崇高自我犧牲",        type: "Ativo",      rarity: "4★", effect: "死亡時使隊伍恢復 100% 生命值／魔力",       cooldown: "300s",   desc: "以自身力量進行崇高犧牲。" },
      { name: "生命平衡",                  type: "Ativo",      rarity: "3★", effect: "平均 生命值的所有 隊伍",                cooldown: "60s",    desc: "重新平衡生命值。" },
      { name: "群體復活",             type: "Ativo",      rarity: "4★", effect: "使所有隊伍成員以 40% 生命值 復活",        cooldown: "300s",   desc: "使多名倒下的盟友復活。" },
      ...
      { name: "樞機主教之軀",          type: "Passivo",    rarity: "3★", effect: "+12% 最大魔力, +10% 魔法防禦",                cooldown: "N/A",    desc: "獲得神聖強化的身軀。" }
    ]
  },
  ...
  prophet: {
    ...
    skills: [
      ...
      { name: "狂戰士之魂",    type: "Self-Buff",  rarity: "2★", effect: "+20% 攻擊力, +20% 魔法攻擊, -10% 防禦力 20 分鐘",cooldown: "50 min", desc: "喚醒狂戰士之魂。" },
      ...
      { name: "先知和諧",  type: "Self-Buff",  rarity: "3★", effect: "+30% 攻擊力, +25% 魔法攻擊, +20% 防禦力 25 分鐘", cooldown: "60 min", desc: "先知的戰鬥和諧。" }
    ]
  },
  ...
  hierophant: {
    ...
    skills: [
      { name: "火之預言",             type: "Party-Buff", rarity: "3★", effect: "+30% 攻擊力, +15% 暴擊 隊伍 12 分鐘",        cooldown: "30 min", desc: "施放火之預言。" },
      ...
      { name: "聖言者和諧",         type: "Self-Buff",  rarity: "4★", effect: "+50% 攻擊力, +45% 魔法攻擊, +35% 防禦力 30 分鐘",    cooldown: "90 min", desc: "聖言者的戰鬥和諧。" },
      { name: "預言大師",           type: "Passivo",    rarity: "3★", effect: "+15% 增益 持續時間, +5% 對怪物",             cooldown: "N/A",    desc: "精通各式預言。" },
      { name: "聖言者之魂",            type: "Passivo",    rarity: "3★", effect: "+12% 神聖 攻擊力, +8% 治癒",                  cooldown: "N/A",    desc: "聖言者的戰鬥精神。" },
      { name: "聖言者之軀",       type: "Passivo",    rarity: "3★", effect: "+10% 最大生命值, +10% 最大魔力",                cooldown: "N/A",    desc: "強化聖言者的身軀。" }
    ]
  },
  ...
  elfFighter: {
    ...
    skills: [
      ...
      { name: "生命值提升（等級1）",     type: "Passivo",  rarity: "1★", effect: "+5% 最大生命值",                     cooldown: "N/A",    desc: "強化精靈體質。" },
      { name: "輕甲精通", type: "Passivo",  rarity: "1★", effect: "+8% 防禦力 裝備輕甲時",      cooldown: "N/A",    desc: "精通輕型防具。" }
    ]
  },
  ...
  elvenKnight: {
    ...
    skills: [
      ...
      { name: "力量削弱",           type: "Ativo",    rarity: "1★", effect: "傷害 150% + -20% 攻擊力 8 秒",      cooldown: "14s",    desc: "削弱敵人的力量。" },
      { name: "重甲精通",   type: "Passivo",  rarity: "1★", effect: "+15% 防禦力 重甲",     cooldown: "N/A",    desc: "精通重型防具。" },
      { name: "盾牌精通",        type: "Passivo",  rarity: "1★", effect: "+15% 格擋率",              cooldown: "N/A",    desc: "精通盾牌防禦。" },
      { name: "劍／鈍器精通",   type: "Passivo",  rarity: "1★", effect: "+10% 攻擊力 劍／鈍器",        cooldown: "N/A",    desc: "精通劍與鈍器。" },
      { name: "生命值提升（等級2）",       type: "Passivo",  rarity: "1★", effect: "+10% 最大生命值",                  cooldown: "N/A",    desc: "進一步強化體質。" },
  ...
  templeKnight: {
    ...
    skills: [
      { name: "盾牌暈擊",           type: "Ativo",    rarity: "2★", effect: "傷害 200% + 暈眩 3 秒",           cooldown: "18s",    desc: "以盾牌重擊使敵人暈眩。" },
      { name: "審判",              type: "Ativo",    rarity: "2★", effect: "傷害 240% + -20% 防禦力 10 秒",      cooldown: "20s",    desc: "施展神殿的審判。" },
      { name: "伊娃意志",            type: "Ativo",    rarity: "3★", effect: "+30% 水抗性 + 治癒 15% 生命值",cooldown: "45s",   desc: "獲得伊娃的意志。" },
      ...
      { name: "聖殿騎士和諧",          type: "Self-Buff",rarity: "3★", effect: "+35% 防禦力, +25% 生命值, +15% 迴避 25 分鐘",cooldown: "60 min",desc: "聖殿騎士的戰鬥和諧。" },
      { name: "生命值強化",              type: "Passivo",  rarity: "2★", effect: "+15% 最大生命值",                    cooldown: "N/A",    desc: "強化 生命值。" },
  ...
  evaTemplar: {
    ...
    skills: [
      { name: "伊娃之觸",                  type: "Ativo",    rarity: "3★", effect: "範圍治療隊伍 25% 生命值 + 淨化 1 個減益效果", cooldown: "35s",    desc: "施展伊娃之觸。" },
      ...
      { name: "召喚守護亞加西翁",       type: "Ativo",    rarity: "3★", effect: "召喚 守護亞加西翁 (+15% 防禦力)",     cooldown: "120s",   desc: "召喚守護型亞加西翁。" },
      { name: "超越盾牌衝鋒",    type: "Ativo",    rarity: "4★", effect: "突進 + 480% 傷害 + 範圍 嘲諷 10 秒",        cooldown: "160s",   desc: "施展超越極限的盾牌突進。" },
      { name: "伊娃聖殿騎士和諧",         type: "Self-Buff",rarity: "4★", effect: "+55% 防禦力, +40% 生命值, +25% 魔法防禦 30 分鐘",     cooldown: "90 min", desc: "伊娃聖殿騎士的至高戰鬥和諧。" },
      { name: "戰鬥大師",              type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +15% 仇恨, +5% 對怪物",           cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      { name: "伊娃聖殿騎士之魂",          type: "Passivo",  rarity: "3★", effect: "水屬性 攻擊力 +15%、格擋率 +10%",              cooldown: "N/A",    desc: "伊娃聖殿騎士的戰鬥精神。" },
      { name: "伊娃聖殿騎士之軀",         type: "Passivo",  rarity: "3★", effect: "+15% 最大生命值, +10% 防禦力",                  cooldown: "N/A",    desc: "強化伊娃聖殿騎士的身軀。" },
      { name: "伊娃守護",             type: "Passivo",  rarity: "3★", effect: "+15% 水抗性",                       cooldown: "N/A",    desc: "獲得伊娃的守護。" },
      { name: "伊娃援助",                    type: "Passivo",  rarity: "3★", effect: "受到攻擊時有 10% 機率恢復 5% 生命值",   cooldown: "N/A",    desc: "觸發伊娃的援助效果。" }
    ]
  },
  ...
  swordSinger: {
    ...
    skills: [
      { name: "大地之歌",         type: "Self-Buff", rarity: "2★", effect: "+20% 防禦力 持續 20 分鐘",            cooldown: "50 min", desc: "吟唱大地之歌。" },
      { name: "生命之歌",          type: "Self-Buff", rarity: "2★", effect: "+15% 生命值恢復 持續 20 分鐘",       cooldown: "50 min", desc: "吟唱生命之歌。" },
      ...
      { name: "召喚之歌",    type: "Self-Buff", rarity: "2★", effect: "+15% 魔力恢復 持續 20 分鐘",       cooldown: "50 min", desc: "吟唱召喚之歌。" },
      { name: "活力之歌",      type: "Self-Buff", rarity: "2★", effect: "+15% 最大生命值 持續 20 分鐘",         cooldown: "50 min", desc: "吟唱活力之歌。" },
      ...
      { name: "冠軍之歌",      type: "Self-Buff", rarity: "3★", effect: "+20% 攻擊力 持續 20 分鐘",            cooldown: "50 min", desc: "吟唱冠軍之歌。" },
      { name: "更新之歌",       type: "Self-Buff", rarity: "3★", effect: "+10% 生命值+魔力恢復 持續 20 分鐘",    cooldown: "50 min", desc: "吟唱更新之歌。" },
      { name: "劍歌者和諧",          type: "Self-Buff", rarity: "3★", effect: "+30% 攻擊力, +20% 防禦力, +15% 速度 25 分鐘",cooldown: "60 min",desc: "劍歌者的戰鬥和諧。" },
      { name: "重甲精通",   type: "Passivo",  rarity: "1★", effect: "+12% 防禦力 重甲",        cooldown: "N/A",    desc: "精通重型防具。" },
      { name: "生命值強化",              type: "Passivo",  rarity: "1★", effect: "+12% 最大生命值",                     cooldown: "N/A",    desc: "強化 生命值。" }
    ]
  },
  ...
  swordMuse: {
    ...
    skills: [
      ...
      { name: "元素之歌",       type: "Self-Buff", rarity: "3★", effect: "+20% 全 元素 攻擊力 持續 20 分鐘", cooldown: "50 min", desc: "吟唱元素之歌。" },
      ...
      { name: "劍之繆思和諧",      type: "Self-Buff", rarity: "4★", effect: "+50% 攻擊力、+40% 防禦力、+30% 歌曲效果，持續 30 分鐘",cooldown: "90 min",desc: "劍之繆思的戰鬥和諧。" },
      { name: "劍之繆思之魂",       type: "Passivo",   rarity: "3★", effect: "+15% 歌曲效果",           cooldown: "N/A",    desc: "劍之繆思的戰鬥精神。" },
      { name: "劍之繆思之軀",      type: "Passivo",   rarity: "3★", effect: "+10% 最大生命值, +10% 最大魔力",         cooldown: "N/A",    desc: "強化劍之繆思的身軀。" }
    ]
  },
  ...
  plainsWalker: {
    ...
    skills: [
      ...
      { name: "平原行者和諧",      type: "Self-Buff",rarity: "3★", effect: "+35% 暴擊, +25% 迴避, +20% 攻擊力 25 分鐘",cooldown: "60 min",desc: "平原行者的戰鬥和諧。" },
      { name: "迴避",           type: "Passivo",  rarity: "2★", effect: "+12% 迴避",                         cooldown: "N/A",    desc: "進一步提高迴避能力。" },
      { name: "暴擊威力",    type: "Passivo",  rarity: "2★", effect: "+18% 暴擊傷害",                 cooldown: "N/A",    desc: "提高暴擊威力。" },
      { name: "專注",             type: "Passivo",  rarity: "1★", effect: "+10% 暴擊率",                   cooldown: "N/A",    desc: "提升專注力。" }
    ]
  ...
  windRider: {
    ...
    skills: [
      ...
      { name: "刺激冒險",          type: "Self-Buff",rarity: "3★", effect: "+45% 迴避, +30% 暴擊, +20% 攻擊力 20 分鐘",cooldown: "55 min",desc: "進入精靈式的冒險戰鬥狀態。" },
      { name: "幸運打擊",               type: "Ativo",    rarity: "3★", effect: "傷害 420% + 2 倍掉落機率",         cooldown: "30s",    desc: "施展帶來額外收穫的幸運攻擊。" },
      { name: "超越致命打擊",    type: "Ativo",    rarity: "4★", effect: "傷害 650% + 無視 迴避 + 流血 12 秒", cooldown: "150s",   desc: "施展超越極限的致命攻擊。" },
      { name: "風騎士和諧",          type: "Self-Buff",rarity: "4★", effect: "+55% 暴擊, +45% 迴避, +35% 攻擊力 30 分鐘",cooldown: "90 min",desc: "風騎士的至高戰鬥和諧。" },
      { name: "戰鬥大師",            type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +10% 暴擊, +5% 對怪物",      cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      { name: "暗影感知",                type: "Passivo",  rarity: "3★", effect: "+15% 迴避 夜間/地城",           cooldown: "N/A",    desc: "感知暗影中的動靜。" },
      { name: "風騎士之魂",           type: "Passivo",  rarity: "3★", effect: "+12% 匕首攻擊",                    cooldown: "N/A",    desc: "風騎士的戰鬥精神。" },
      { name: "風騎士之軀",          type: "Passivo",  rarity: "3★", effect: "+10% 最大生命值, +8% 迴避",              cooldown: "N/A",    desc: "獲得風一般靈活的身軀。" },
      { name: "最終狂熱",                type: "Passivo",  rarity: "3★", effect: "+25% 攻擊力 當 生命值 < 30%",           cooldown: "N/A",    desc: "在危急狀態下進入最終狂熱。" }
    ]
  },
  ...
  silverRanger: {
    ...
    skills: [
      ...
      { name: "銀月遊俠和諧",      type: "Self-Buff",rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +15% 射程 25 分鐘",cooldown: "60 min",desc: "銀月遊俠的戰鬥和諧。" },
      { name: "弓精通",       type: "Passivo",  rarity: "2★", effect: "+18% 攻擊力 使用弓時",              cooldown: "N/A",    desc: "精通弓類武器。" },
      { name: "遠距射擊",         type: "Passivo",  rarity: "2★", effect: "+30% 射程",                      cooldown: "N/A",    desc: "提高射擊距離。" },
      { name: "專注",             type: "Passivo",  rarity: "1★", effect: "+10% 暴擊率",                  cooldown: "N/A",    desc: "提升專注力。" },
      { name: "暴擊威力",    type: "Passivo",  rarity: "2★", effect: "+18% 暴擊傷害",                cooldown: "N/A",    desc: "提高暴擊威力。" },
  ...
  moonlightSentinel: {
    ...
    skills: [
      { name: "七連矢",                  type: "Ativo",    rarity: "3★", effect: "7 箭矢, 總傷害 480%",               cooldown: "25s",    desc: "連續射出七支箭矢。" },
      { name: "死亡之眼",                     type: "Self-Buff",rarity: "3★", effect: "+50% 攻擊力, +40% 射程 20 分鐘",              cooldown: "55 min", desc: "進入致命瞄準狀態。" },
      { name: "精準射擊",                type: "Ativo",    rarity: "3★", effect: "傷害 400% + 無視 50% 防禦力",              cooldown: "28s",    desc: "對要害施展精準射擊。" },
      { name: "三重射擊",                  type: "Ativo",    rarity: "3★", effect: "3 次射擊, 總傷害 360%",              cooldown: "14s",    desc: "連續射擊三次。" },
      { name: "荊棘射擊",                   type: "Ativo",    rarity: "2★", effect: "傷害 260% + 流血 10 秒",                   cooldown: "12s",    desc: "發射帶有荊棘力量的箭矢。" },
      { name: "束縛射擊",                 type: "Ativo",    rarity: "2★", effect: "傷害 220% + 定身 4 秒",                     cooldown: "18s",    desc: "發射可束縛敵人的箭矢。" },
      ...
      { name: "超越七連矢",     type: "Ativo",    rarity: "4★", effect: "傷害 700% + 元素 + 無視 防禦力",      cooldown: "180s",   desc: "施展超越極限的七連箭攻擊。" },
      { name: "月光守衛和諧",            type: "Self-Buff",rarity: "4★", effect: "+60% 攻擊力, +50% 暴擊, +40% 射程 30 分鐘",   cooldown: "90 min", desc: "月光守衛的戰鬥和諧。" },
      { name: "戰鬥大師",             type: "Passivo",  rarity: "3★", effect: "+10% 攻擊力, +10% 射程, +5% 對怪物",          cooldown: "N/A",    desc: "精通各式戰鬥技巧。" },
      { name: "月光守衛之魂",    type: "Passivo",  rarity: "3★", effect: "+15% 弓攻擊",                            cooldown: "N/A",    desc: "月光守衛的戰鬥精神。" },
      { name: "月光守衛之軀",   type: "Passivo",  rarity: "3★", effect: "+10% 最大生命值, +8% 迴避",                   cooldown: "N/A",    desc: "強化月光守衛的身軀。" }
    ]
  },
  ...
  elvenWizard: {
    ...
    skills: [
      ...
      { name: "水之漩渦",         type: "Ativo",    rarity: "1★", effect: "傷害 水 200% + 緩速 20% 5 秒",   cooldown: "10s",    desc: "召喚水流漩渦。" },
      { name: "光環燃燒",          type: "Ativo",    rarity: "2★", effect: "範圍 火 180% 周圍",         cooldown: "14s",    desc: "以魔力燃燒周圍敵人。" },
      { name: "生命吸取",         type: "Ativo",    rarity: "2★", effect: "傷害 190% + 吸取 25% 生命值",       cooldown: "15s",    desc: "吸取目標生命力。" },
      { name: "精靈巫師和諧",   type: "Self-Buff",rarity: "2★", effect: "+25% 魔法攻擊, +15% 施法速度 20 分鐘",cooldown: "45 min",desc: "精靈巫師的戰鬥和諧。" },
      { name: "魔力強化",         type: "Passivo",  rarity: "1★", effect: "+12% 最大魔力",                    cooldown: "N/A",    desc: "強化魔力儲備。" }
    ]
  },
  ...
  mysticMuse: {
    ...
    skills: [
      ...
      { name: "神秘繆思和諧",           type: "Self-Buff",rarity: "4★", effect: "+55% 魔法攻擊, +35% 施法速度, +20% 魔力 30 分鐘",cooldown: "90 min",desc: "神秘繆思的戰鬥和諧。" },
      ...
      { name: "神秘繆思之軀",       type: "Passivo",  rarity: "3★", effect: "+10% 最大魔力, +8% 魔法防禦",                 cooldown: "N/A",    desc: "強化神秘繆思的身軀。" }
    ]
  },
  ...
  elementalSummoner: {
    ...
    skills: [
      { name: "召喚拳鬥獨角獸",   type: "Ativo",    rarity: "2★", effect: "召喚 戰鬥獨角獸 (攻擊力 50%)",  cooldown: "60s",    desc: "召喚擅長近戰的獨角獸。" },
      { name: "召喚幻影獨角獸",  type: "Ativo",    rarity: "2★", effect: "召喚 魔法獨角獸 (魔法攻擊 50%)",  cooldown: "60s",    desc: "召喚具有幻影能力的獨角獸。" },
      { name: "召喚梅洛獨角獸",  type: "Ativo",    rarity: "3★", effect: "召喚梅洛（攻擊力 65%，坦克型）",      cooldown: "90s",    desc: "召喚水元素獨角獸梅洛。" },
      { name: "召喚獸治癒",          type: "Ativo",    rarity: "2★", effect: "治癒召喚物 35% 生命值",                 cooldown: "12s",    desc: "治療召喚獸。" },
      { name: "召喚獸回復",      type: "Ativo",    rarity: "2★", effect: "恢復召喚物 30% 魔力",          cooldown: "15s",    desc: "恢復召喚獸的魔力。" },
      { name: "痛苦轉移",          type: "Toggle",   rarity: "2★", effect: "50% 傷害 受到的 轉移給 召喚物",   cooldown: "N/A",    desc: "將部分受到的傷害轉移給召喚獸。" },
      { name: "召喚生命晶體",      type: "Ativo",    rarity: "2★", effect: "晶體 會 治癒 5%/5 秒",               cooldown: "45s",    desc: "召喚具有生命恢復能力的晶體。" },
      { name: "元素召喚師和諧",           type: "Self-Buff",rarity: "3★", effect: "+30% 魔法攻擊, +25% 召喚物 攻擊力 25 分鐘",  cooldown: "60 min", desc: "元素召喚師的戰鬥和諧。" },
      { name: "召喚獸物理攻擊",  type: "Passivo",  rarity: "2★", effect: "+15% 召喚物 攻擊力",                    cooldown: "N/A",    desc: "提高召喚獸的物理攻擊能力。" }
    ]
  },
  ...
  elementalMaster: {
    ...
    skills: [
      ...
      { name: "召喚獸屏障",               type: "Ativo",    rarity: "3★", effect: "召喚物 獲得護盾 5000 生命值 15 秒",          cooldown: "60s",    desc: "為召喚獸展開防護屏障。" },
      { name: "群體召喚獸治癒",             type: "Ativo",    rarity: "3★", effect: "治癒所有召喚物 40% 生命值",               cooldown: "25s",    desc: "治療多個召喚獸。" },
      ...
      { name: "獨角獸友誼",           type: "Passivo",  rarity: "3★", effect: "+20% 召喚物 攻擊力/防禦力",                     cooldown: "N/A",    desc: "獨角獸之間的友誼。" },
      { name: "元素專注",        type: "Passivo",  rarity: "3★", effect: "+10% 魔法攻擊, +10% 召喚物 生命值",              cooldown: "N/A",    desc: "提高元素專注力。" },
      { name: "元素大師之魂",        type: "Passivo",  rarity: "3★", effect: "+12% 魔法攻擊, +8% 召喚物 速度",            cooldown: "N/A",    desc: "元素大師的戰鬥精神。" },
      { name: "元素大師之軀",   type: "Passivo",  rarity: "3★", effect: "+10% 最大魔力, +8% 最大生命值",                cooldown: "N/A",    desc: "強化元素大師的身軀。" }
    ]
  },
  ...
  elfOracle: {
    ...
    skills: [
      { name: "治癒",          type: "Ativo",      rarity: "1★", effect: "治癒 25% 生命值 目標",              cooldown: "8s",     desc: "進行基礎治療。" },
      { name: "戰鬥治癒",   type: "Ativo",      rarity: "1★", effect: "治癒 20% 生命值 + 移除 1 減益", cooldown: "10s",    desc: "在戰鬥中快速治療。" },
      { name: "力量",         type: "Party-Buff", rarity: "1★", effect: "+15% 攻擊力 隊伍 10 分鐘",         cooldown: "25 min", desc: "賦予提升力量的祝福。" },
      { name: "盾牌祝福", type: "Party-Buff", rarity: "1★", effect: "+15% 防禦力 隊伍 10 分鐘",         cooldown: "25 min", desc: "賦予防護祝福。" },
      { name: "解毒",   type: "Ativo",      rarity: "1★", effect: "移除 中毒",                 cooldown: "5s",     desc: "解除中毒狀態。" },
      { name: "止血",    type: "Ativo",      rarity: "1★", effect: "移除 流血",                  cooldown: "5s",     desc: "解除流血狀態。" },
      { name: "魔力回復",      type: "Ativo",      rarity: "1★", effect: "恢復 20% 魔力 目標",          cooldown: "12s",    desc: "恢復魔力。" }
    ]
  },
  ...
  elfElder: {
    ...
    skills: [
      { name: "高級治癒",       type: "Ativo",      rarity: "2★", effect: "治癒 40% 生命值 目標",                    cooldown: "10s",    desc: "施展更強力的治療。" },
      { name: "高級群體治癒", type: "Ativo",      rarity: "3★", effect: "治癒 30% 生命值 隊伍",                   cooldown: "18s",    desc: "治療隊伍成員。" },
      { name: "復活",       type: "Ativo",      rarity: "3★", effect: "復活 盟友 30% 生命值",            cooldown: "120s",   desc: "使倒下的目標復活。" },
      ...
      { name: "靈活思緒",             type: "Self-Buff",  rarity: "2★", effect: "+25% 施法速度 持續 20 分鐘",          cooldown: "50 min", desc: "提高施法效率。" },
      { name: "加速",              type: "Self-Buff",  rarity: "2★", effect: "+30% 攻擊速度 持續 20 分鐘",           cooldown: "50 min", desc: "提高行動與攻擊速度。" },
      { name: "清澈思緒",            type: "Self-Buff",  rarity: "2★", effect: "+20% 魔力恢復 持續 20 分鐘",            cooldown: "50 min", desc: "提高魔法運用效率。" },
      { name: "水之預言",  type: "Party-Buff", rarity: "3★", effect: "+30% 魔法攻擊, +20% 魔法防禦 隊伍 12 分鐘",  cooldown: "30 min", desc: "施放水之預言。" },
      { name: "精神之盾",      type: "Party-Buff", rarity: "2★", effect: "+20% 魔法防禦 隊伍 12 分鐘",            cooldown: "30 min", desc: "提高精神異常抗性。" },
  ...
  evaSaint: {
    ...
    skills: [
      { name: "崇高自我犧牲",        type: "Ativo",      rarity: "4★", effect: "死亡時使隊伍恢復 100% 生命值／魔力",    cooldown: "300s",   desc: "進行自我犧牲。" },
      { name: "生命平衡",                  type: "Ativo",      rarity: "3★", effect: "平均 生命值的所有 隊伍",             cooldown: "60s",    desc: "重新平衡生命值。" },
      { name: "群體復活",             type: "Ativo",      rarity: "4★", effect: "復活 所有 隊伍 40% 生命值",         cooldown: "300s",   desc: "使多名倒下的盟友復活。" },
      { name: "奇蹟",                       type: "Ativo",      rarity: "4★", effect: "治癒隊伍 80% 生命值 + 復活死亡成員",  cooldown: "300s",   desc: "施展奇蹟之力。" },
      ...
      { name: "伊娃聖者之軀",           type: "Passivo",    rarity: "3★", effect: "+12% 最大魔力, +10% 魔法防禦",             cooldown: "N/A",    desc: "強化伊娃聖者的身軀。" },
      { name: "伊娃援助",                    type: "Passivo",    rarity: "3★", effect: "受到攻擊時有 10% 機率恢復 5% 生命值",cooldown: "N/A",    desc: "觸發伊娃的援助效果。" }
    ]
  },
...
{ name: "包紮", type: "Ativo", rarity: "1★", effect: "恢復 15% 生命值", cooldown: "30s", duration: null, note: "轉職後技能仍會保留" },
{ name: "生命值提升", type: "Passivo", rarity: "1★", effect: "+10% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
{ name: "輕甲精通", type: "Passivo", rarity: "1★", effect: "+8% 防禦力 裝備輕甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
{ name: "黑暗之魂", type: "Self-Buff", rarity: "1★", effect: "+10% 攻擊力 並 +8% 暴擊 持續 15 分鐘", cooldown: "30 min", duration: "15 min", note: "轉職後技能仍會保留" }
]
},
...
{ name: "力量削弱", type: "Ativo", rarity: "1★", effect: "傷害 140% + 降低 攻擊力 15%", cooldown: "14s", duration: "8s", note: "轉職後技能仍會保留" },
{ name: "盾牌精通", type: "Passivo", rarity: "1★", effect: "裝備盾牌時 防禦力 +15%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
{ name: "重甲精通", type: "Passivo", rarity: "1★", effect: "+15% 防禦力 裝備重甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
{ name: "劍／鈍器精通", type: "Passivo", rarity: "1★", effect: "+12% 攻擊力 使用劍／鈍器時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
...
{ name: "生命吸取", type: "Ativo", rarity: "2★", effect: "傷害 220% + 吸取 30% 生命值", cooldown: "16s", duration: null, note: "轉職後技能仍會保留" },
...
{ name: "犧牲", type: "Ativo", rarity: "2★", effect: "將自身 30% 生命值 轉移給盟友", cooldown: "30s", duration: null, note: "轉職後技能仍會保留" },
{ name: "神盾", type: "Ativo", rarity: "2★", effect: "+50% 格擋率 持續 15 秒", cooldown: "45s", duration: "15s", note: "轉職後技能仍會保留" },
{ name: "終極防禦", type: "Ativo", rarity: "3★", effect: "+80% 防禦力, 無法移動, 10 秒", cooldown: "120s", duration: "10s", note: "轉職後技能仍會保留" },
...
{ name: "生命值強化", type: "Passivo", rarity: "1★", effect: "+15% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
{ name: "席琳騎士和諧", type: "Self-Buff", rarity: "3★", effect: "+35% 防禦力, +25% 攻擊力, +20% 黑暗 傷害 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
]
},
...
skills: [
{ name: "席琳之觸", type: "Ativo", rarity: "3★", effect: "傷害 黑暗 350% + 吸取 35% 生命值", cooldown: "25s", duration: null, note: "轉職後技能仍會保留" },
...
{ name: "席琳詛咒", type: "Ativo", rarity: "3★", effect: "傷害 黑暗 範圍 360% + 降低 防禦力 20%", cooldown: "28s", duration: "8s", note: "轉職後技能仍會保留" },
{ name: "召喚守護亞加西翁", type: "Ativo", rarity: "3★", effect: "守護亞加西翁 (+15% 防禦力 隊伍)", cooldown: "90s", duration: "120s", note: "轉職後技能仍會保留" },
...
{ name: "席琳聖殿騎士之魂", type: "Passivo", rarity: "3★", effect: "+25% 防禦力, +20% 最大生命值, +15% 黑暗 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
{ name: "席琳聖殿騎士之軀", type: "Passivo", rarity: "3★", effect: "+20% 黑暗 抗性, +15% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
...
{ name: "席琳聖殿騎士和諧", type: "Self-Buff", rarity: "4★", effect: "+55% 防禦力, +40% 最大生命值, +30% 黑暗 傷害 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
]
},
  ...
  bladeDancer: {
    ...
    skills: [
      { name: "火焰之舞",          type: "Party-Buff", rarity: "2★", effect: "隊伍 攻擊力 +20%", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "戰士之舞",       type: "Party-Buff", rarity: "2★", effect: "隊伍 物理攻擊 與 防禦力 +15%", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "吸血鬼之舞",       type: "Party-Buff", rarity: "3★", effect: "隊伍將造成傷害的 8% 轉化為 生命值", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "守護之舞",    type: "Party-Buff", rarity: "2★", effect: "隊伍 防禦力 +15%", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "暗影之舞",        type: "Party-Buff", rarity: "3★", effect: "隊伍迴避 +15%", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "海妖之舞",         type: "Party-Buff", rarity: "3★", effect: "隊伍 魔力恢復 +20%", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "雙武器精通",    type: "Passivo",    rarity: "1★", effect: "裝備雙劍時 攻擊力 +15%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "重甲精通",    type: "Passivo",    rarity: "1★", effect: "+15% 防禦力 裝備重甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "生命值強化",               type: "Passivo",    rarity: "1★", effect: "+15% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "劍舞者和諧", type: "Self-Buff",  rarity: "3★", effect: "+30% 攻擊力, +20% 攻擊速度, +15% 迴避 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  spectralDancer: {
    ...
    skills: [
      { name: "狂戰士之舞",          type: "Party-Buff", rarity: "3★", effect: "隊伍 攻擊力 +25%、攻擊速度 +20%、防禦力 -10%", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "幽靈舞者之魂",      type: "Passivo",    rarity: "3★", effect: "+20% 攻擊力, +15% 迴避, +15% 黑暗 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈舞者之軀",     type: "Passivo",    rarity: "3★", effect: "+15% 暴擊率, +10% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",            type: "Passivo",    rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈舞者和諧",     type: "Self-Buff",  rarity: "4★", effect: "+50% 攻擊力, +35% 攻擊速度, +30% 迴避 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  assassinDE: {
    ...
    skills: [
      ...
      { name: "匕首精通",        type: "Passivo", rarity: "1★", effect: "裝備匕首時 攻擊力 +12%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  abyssWalker: {
    ...
    skills: [
      ...
      { name: "深淵行者和諧", type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +20% 迴避 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  ghostHunter: {
    ...
    skills: [
      ...
      { name: "超越致命打擊",  type: "Ativo",    rarity: "4★", effect: "傷害 620% + 無視 防禦力 + 流血 8 秒", cooldown: "160s", duration: "8s bleed", note: "轉職後技能仍會保留" },
      { name: "暗影感知",             type: "Passivo",  rarity: "3★", effect: "夜間或地城中暴擊率 +25%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "最終狂熱",             type: "Passivo",  rarity: "3★", effect: "+30% 攻擊力 當 生命值 < 30%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈獵人之魂",      type: "Passivo",  rarity: "3★", effect: "+20% 攻擊力, +20% 暴擊威力, +15% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈獵人之軀",     type: "Passivo",  rarity: "3★", effect: "+15% 最大生命值, +10% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",         type: "Passivo",  rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈獵人和諧",     type: "Self-Buff", rarity: "4★", effect: "+55% 攻擊力, +45% 暴擊, +35% 迴避 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  phantomRanger: {
    ...
    skills: [
      ...
      { name: "詛咒射擊",         type: "Ativo",   rarity: "2★", effect: "傷害 220% + 詛咒（防禦力 -20%）", cooldown: "16s", duration: "8s", note: "轉職後技能仍會保留" },
      { name: "弓精通",      type: "Passivo", rarity: "1★", effect: "+15% 攻擊力 使用弓時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "遠距射擊",        type: "Passivo", rarity: "2★", effect: "+30% 射程", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "專注",            type: "Passivo", rarity: "1★", effect: "+10% 暴擊率", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "暴擊威力",   type: "Passivo", rarity: "2★", effect: "+20% 暴擊威力", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "迴避",          type: "Passivo", rarity: "1★", effect: "+12% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈遊俠和諧", type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +20% 射程 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  ghostSentinel: {
    ...
    skills: [
      ...
      { name: "死亡之眼",                      type: "Self-Buff", rarity: "3★", effect: "+50% 攻擊力, +40% 射程 持續 18 分鐘", cooldown: "55 min", duration: "18 min", note: "轉職後技能仍會保留" },
      { name: "精準射擊",                 type: "Ativo",   rarity: "3★", effect: "傷害 380% + 無視 防禦力", cooldown: "22s", duration: null, note: "轉職後技能仍會保留" },
      ...
      { name: "幽靈守衛之魂",         type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +20% 暴擊威力, +15% 射程", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈守衛之軀",        type: "Passivo", rarity: "3★", effect: "+15% 最大生命值, +10% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",              type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "幽靈守衛和諧",        type: "Self-Buff", rarity: "4★", effect: "+55% 攻擊力, +45% 暴擊, +35% 射程 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  darkElfMage: {
    ...
    skills: [
      ...
      { name: "自我治癒",      type: "Ativo",   rarity: "1★", effect: "恢復 20% 生命值", cooldown: "15s", duration: null, note: "轉職後技能仍會保留" },
      ...
      { name: "魔力提升",    type: "Passivo", rarity: "1★", effect: "+10% 最大魔力", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  darkWizard: {
    ...
    skills: [
      ...
      { name: "生命吸取",       type: "Ativo",   rarity: "2★", effect: "傷害 黑暗 200% + 吸取 25%為 生命值", cooldown: "14s", duration: null, note: "轉職後技能仍會保留" },
      { name: "魔力強化",       type: "Passivo", rarity: "1★", effect: "+15% 最大魔力", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  spellhowler: {
    ...
    skills: [
      ...
      { name: "身心轉換",     type: "Ativo",   rarity: "2★", effect: "轉換 20% 生命值於魔力", cooldown: "30s", duration: null, note: "轉職後技能仍會保留" },
  ...
  stormScreamer: {
    ...
    skills: [
      ...
      { name: "精通（稀有）",               type: "Passivo", rarity: "4★", effect: "魔法技能威力 +10%、對怪物傷害 +15%、最大魔力 +15%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "暴風狂嘯者之魂",        type: "Passivo", rarity: "3★", effect: "+20% 魔法攻擊, +15% 風 傷害, +10% 施法速度", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "暴風狂嘯者之軀",       type: "Passivo", rarity: "3★", effect: "+15% 最大魔力, +10% 魔力恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  phantomSummoner: {
    ...
    skills: [
      { name: "召喚夢魘",       type: "Ativo",   rarity: "2★", effect: "召喚 夢魘 (攻擊力 高, 坦克 中)", cooldown: "45s", duration: "Permanente", note: "轉職後技能仍會保留" },
      { name: "召喚怨靈",          type: "Ativo",   rarity: "2★", effect: "召喚 怨靈 (攻擊力 中, 吸取 生命值)", cooldown: "45s", duration: "Permanente", note: "轉職後技能仍會保留" },
      { name: "召喚幽靈領主",   type: "Ativo",   rarity: "3★", effect: "召喚 幽靈領主 (範圍 + 坦克)", cooldown: "60s", duration: "Permanente", note: "轉職後技能仍會保留" },
      { name: "召喚獸治癒",          type: "Ativo",   rarity: "1★", effect: "治癒召喚物 30% 生命值", cooldown: "12s", duration: null, note: "轉職後技能仍會保留" },
      { name: "召喚獸回復",      type: "Ativo",   rarity: "1★", effect: "恢復召喚物 魔力", cooldown: "15s", duration: null, note: "轉職後技能仍會保留" },
      ...
      { name: "召喚獸物理攻擊", type: "Passivo", rarity: "2★", effect: "召喚物 攻擊力 +20%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  spectralMaster: {
    ...
    skills: [
      { name: "召喚強化幽靈領主", type: "Ativo", rarity: "3★", effect: "幽靈領主 強化 (+50% 攻擊力/生命值)", cooldown: "90s", duration: "Permanente", note: "轉職後技能仍會保留" },
      ...
      { name: "幽靈大師之軀", type: "Passivo",  rarity: "3★", effect: "+15% 最大生命值/魔力, +10% 魔力恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",            type: "Passivo",  rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  shillienOracle: {
    ...
    skills: [
      ...
      { name: "力量",           type: "Party-Buff", rarity: "1★", effect: "隊伍 攻擊力 +10%", cooldown: "20s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "盾牌",          type: "Party-Buff", rarity: "1★", effect: "隊伍 防禦力 +10%", cooldown: "20s", duration: "300s", note: "轉職後技能仍會保留" },
      ...
      { name: "魔力回復",        type: "Ativo",   rarity: "1★", effect: "恢復目標 20% 魔力", cooldown: "12s", duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  shillienElder: {
    ...
    skills: [
      ...
      { name: "復活",     type: "Ativo",     rarity: "3★", effect: "以 30% 生命值／魔力 復活盟友", cooldown: "120s", duration: null, note: "轉職後技能仍會保留" },
      ...
      { name: "吸血狂怒",    type: "Party-Buff", rarity: "2★", effect: "隊伍將造成傷害的 8% 轉化為 生命值", cooldown: "30s", duration: "300s", note: "轉職後技能仍會保留" },
  ...
  shillienSaint: {
    ...
    skills: [
      { name: "崇高自我犧牲",      type: "Ativo",    rarity: "4★", effect: "犧牲自身 90% 生命值：完全治療全隊並移除所有減益效果", cooldown: "300s", duration: null, note: "轉職後技能仍會保留" },
      { name: "生命平衡",                type: "Ativo",    rarity: "3★", effect: "將隊伍 生命值 平均化", cooldown: "60s", duration: null, note: "轉職後技能仍會保留" },
      { name: "群體復活",           type: "Ativo",    rarity: "4★", effect: "使所有倒下的盟友以 40% 生命值／魔力 復活", cooldown: "300s", duration: null, note: "轉職後技能仍會保留" },
      { name: "席琳祝福",        type: "Party-Buff", rarity: "3★", effect: "隊伍全屬性 +25%，持續 10 分鐘", cooldown: "60s", duration: "600s", note: "轉職後技能仍會保留" },
      { name: "吸血鬼領主",             type: "Party-Buff", rarity: "3★", effect: "隊伍將造成傷害的 12% 轉化為 生命值", cooldown: "60s", duration: "300s", note: "轉職後技能仍會保留" },
      ...
      { name: "席琳援助",             type: "Passivo",  rarity: "3★", effect: "治療時：15% 機率使受治療目標獲得 攻擊力 +10%，持續 10 秒", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      ...
      { name: "席琳聖者之軀",      type: "Passivo",  rarity: "3★", effect: "+20% 最大魔力, +15% 魔力恢復, +10% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  orcFighter: {
    ...
    skills: [
      ...
      { name: "包紮",        type: "Ativo",   rarity: "1★", effect: "恢復 15% 生命值", cooldown: "30s", duration: null, note: "轉職後技能仍會保留" },
      { name: "生命值提升",    type: "Passivo", rarity: "1★", effect: "+12% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "輕甲精通", type: "Passivo", rarity: "1★", effect: "+8% 防禦力 裝備輕甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "半獸人之魂",     type: "Self-Buff", rarity: "1★", effect: "+12% 攻擊力 和 +10% 生命值 持續 15 分鐘", cooldown: "30 min", duration: "15 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  raider: {
    ...
    skills: [
      ...
      { name: "長柄武器精通",     type: "Passivo", rarity: "1★", effect: "+12% 攻擊力 使用長柄武器時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "劍／鈍器精通", type: "Passivo", rarity: "1★", effect: "+12% 攻擊力 使用劍／鈍器時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "重甲精通", type: "Passivo", rarity: "1★", effect: "+15% 防禦力 裝備重甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  destroyer: {
    ...
    skills: [
      { name: "狂暴",            type: "Ativo",   rarity: "3★", effect: "+100% 攻擊力 當 生命值 < 30%, 持續 30 秒", cooldown: "120s", duration: "30s", note: "轉職後技能仍會保留" },
      { name: "毅力",              type: "Ativo",   rarity: "3★", effect: "以 1 生命值 存活 10 秒（期間不會死亡）", cooldown: "180s", duration: "10s", note: "轉職後技能仍會保留" },
      { name: "旋風",        type: "Ativo",   rarity: "2★", effect: "範圍傷害 260%", cooldown: "18s", duration: null, note: "轉職後技能仍會保留" },
      { name: "狂信者",           type: "Ativo",   rarity: "3★", effect: "+50% 攻擊速度 持續 15 秒, -20% 防禦力", cooldown: "60s", duration: "15s", note: "轉職後技能仍會保留" },
      { name: "戰吼",          type: "Self-Buff", rarity: "2★", effect: "+25% 攻擊力 持續 120 秒", cooldown: "60s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "咆哮",             type: "Ativo",   rarity: "2★", effect: "降低 防禦力 敵人 範圍 -20% 10 秒", cooldown: "25s", duration: "10s", note: "轉職後技能仍會保留" },
      { name: "燃燒劈砍",     type: "Ativo",   rarity: "2★", effect: "火屬性傷害 240% + 燃燒 5 秒", cooldown: "16s", duration: "5s", note: "轉職後技能仍會保留" },
      { name: "專注",            type: "Passivo", rarity: "1★", effect: "+10% 暴擊率", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "生命值強化",         type: "Passivo", rarity: "1★", effect: "+15% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "破壞者和諧", type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +20% 生命值, +15% 攻擊速度 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  titan: {
    ...
    skills: [
      ...
      { name: "真實目標",                type: "Ativo",   rarity: "3★", effect: "傷害 380% + 無視 防禦力", cooldown: "25s", duration: null, note: "轉職後技能仍會保留" },
      { name: "狂怒之拳",              type: "Ativo",   rarity: "3★", effect: "傷害 350% (5 次命中 快速)", cooldown: "30s", duration: null, note: "轉職後技能仍會保留" },
      { name: "靈魂破壞者",               type: "Ativo",   rarity: "3★", effect: "傷害 360% + 吸取 魔力 目標", cooldown: "28s", duration: null, note: "轉職後技能仍會保留" },
      ...
      { name: "泰坦榮耀",             type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +15% 最大生命值, +100% 暴擊威力 使用雙手劍時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "泰坦之魂",               type: "Passivo", rarity: "3★", effect: "+25% 攻擊力, +20% 生命值, +10% 攻擊速度", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "泰坦之軀",          type: "Passivo", rarity: "3★", effect: "+20% 最大生命值, +15% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師：半獸人",      type: "Passivo", rarity: "4★", effect: "+12% 全屬性, +18% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "泰坦和諧",            type: "Self-Buff", rarity: "4★", effect: "+60% 攻擊力, +40% 生命值, +30% 攻擊速度 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  monk: {
    ...
    skills: [
      ...
      { name: "拳套精通",     type: "Passivo", rarity: "1★", effect: "+15% 攻擊力 使用拳套時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "輕甲精通", type: "Passivo", rarity: "1★", effect: "+10% 迴避 裝備輕甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "專注",            type: "Passivo", rarity: "1★", effect: "+10% 暴擊率", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  tyrant: {
    ...
    skills: [
      ...
      { name: "圖騰之魂",      type: "Self-Buff", rarity: "2★", effect: "+20% 攻擊力, +15% 攻擊速度 持續 120 秒", cooldown: "60s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "拳鬥狂怒",         type: "Ativo",   rarity: "2★", effect: "傷害 240% + 解除目標鎖定", cooldown: "20s", duration: null, note: "轉職後技能仍會保留" },
      { name: "狂信者",            type: "Ativo",   rarity: "3★", effect: "+50% 攻擊速度 持續 15 秒, -20% 防禦力", cooldown: "60s", duration: "15s", note: "轉職後技能仍會保留" },
      { name: "狂暴",            type: "Ativo",   rarity: "3★", effect: "+100% 攻擊力 當 生命值 < 30%, 持續 30 秒", cooldown: "120s", duration: "30s", note: "轉職後技能仍會保留" },
      { name: "暴君和諧",  type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +20% 攻擊速度 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  grandKhavatari: {
    ...
    skills: [
      ...
      { name: "鳳凰之魂",          type: "Ativo",   rarity: "4★", effect: "死亡時以 50% 生命值 復活（1 次）", cooldown: "300s", duration: "300s (1 uso)", note: "轉職後技能仍會保留" },
      { name: "迅捷攻擊",                 type: "Ativo",   rarity: "3★", effect: "5 次命中 快速 80% 每次", cooldown: "20s", duration: null, note: "轉職後技能仍會保留" },
      { name: "食人魔精華",               type: "Self-Buff", rarity: "3★", effect: "+40% 攻擊力, +30% 最大生命值 持續 60 秒", cooldown: "120s", duration: "60s", note: "轉職後技能仍會保留" },
      ...
      { name: "大卡巴塔里之魂",       type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +15% 暴擊率, +15% 攻擊速度", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "大卡巴塔里之軀",      type: "Passivo", rarity: "3★", effect: "+20% 最大生命值, +15% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "最終狂熱",                 type: "Passivo", rarity: "3★", effect: "+30% 攻擊力 當 生命值 < 30%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師：半獸人",        type: "Passivo", rarity: "4★", effect: "+12% 全屬性, +18% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "大卡巴塔里和諧",      type: "Self-Buff", rarity: "4★", effect: "+55% 攻擊力, +40% 暴擊, +35% 攻擊速度 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  rider: {
    ...
    skills: [
      ...
      { name: "長槍精通",        type: "Passivo", rarity: "1★", effect: "+10% 攻擊力 使用長槍時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  dragoon: {
    ...
    skills: [
      ...
      { name: "野獸咆哮",           type: "Ativo",   rarity: "2★", effect: "降低 攻擊力 敵人 範圍 -15% 8 秒 + 嘲諷", cooldown: "22s", duration: "8s", note: "轉職後技能仍會保留" },
      { name: "龍騎兵和諧",    type: "Self-Buff", rarity: "2★", effect: "+20% 攻擊力, +15% 防禦力, +10% 生命值 持續 20 分鐘", cooldown: "45 min", duration: "20 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  vanguardRider: {
    ...
    skills: [
      ...
      { name: "戰旗",                   type: "Party-Buff", rarity: "3★", effect: "+20% 攻擊力 和 防禦力 給隊伍 持續 120 秒", cooldown: "60s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "騎乘精通",              type: "Passivo", rarity: "2★", effect: "+20% 攻擊力 騎乘時, +15% 防禦力 騎乘時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  grandVanguard: {
    ...
    skills: [
      ...
      { name: "戰鬥點數精通",                   type: "Passivo", rarity: "3★", effect: "產生戰鬥點數 攻擊時, +5% 攻擊力 每 戰鬥點數 (最多 5)", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "先鋒之魂",              type: "Passivo", rarity: "3★", effect: "+25% 攻擊力, +20% 防禦力, +15% 生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "先鋒之軀",         type: "Passivo", rarity: "3★", effect: "+20% 最大生命值, +15% 生命值恢復, +10% 移動速度", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師：半獸人",        type: "Passivo", rarity: "4★", effect: "+12% 全屬性, +18% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "先鋒和諧",           type: "Self-Buff", rarity: "4★", effect: "+55% 攻擊力, +45% 防禦力, +35% 生命值 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" },
  ...
  shaman: {
    ...
    skills: [
      { name: "治癒",         type: "Ativo",     rarity: "1★", effect: "治癒 250% 魔法攻擊", cooldown: "8s", duration: null, note: "轉職後技能仍會保留" },
      { name: "力量",        type: "Party-Buff", rarity: "1★", effect: "+10% 攻擊力 給隊伍", cooldown: "20s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "盾牌",       type: "Party-Buff", rarity: "1★", effect: "+10% 防禦力 給隊伍", cooldown: "20s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "解毒",  type: "Ativo",     rarity: "1★", effect: "移除 中毒", cooldown: "8s", duration: null, note: "轉職後技能仍會保留" },
      { name: "止血",   type: "Ativo",     rarity: "1★", effect: "移除 流血", cooldown: "8s", duration: null, note: "轉職後技能仍會保留" },
  ...
  overlord: {
    ...
    skills: [
      { name: "血盟力量",            type: "Party-Buff", rarity: "2★", effect: "+15% 攻擊力 給隊伍", cooldown: "30s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "血盟盾牌",           type: "Party-Buff", rarity: "2★", effect: "+15% 防禦力 給隊伍", cooldown: "30s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "血盟之軀",             type: "Party-Buff", rarity: "2★", effect: "+15% 最大生命值 給隊伍", cooldown: "30s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "血盟之魂",             type: "Party-Buff", rarity: "2★", effect: "+15% 最大魔力 給隊伍", cooldown: "30s", duration: "300s", note: "轉職後技能仍會保留" },
      ...
      { name: "挑釁",               type: "Ativo",      rarity: "1★", effect: "嘲諷 10 秒", cooldown: "15s", duration: "10s", note: "轉職後技能仍會保留" },
      { name: "生命值強化",              type: "Passivo",    rarity: "1★", effect: "+15% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "霸主和諧",    type: "Self-Buff",  rarity: "3★", effect: "+30% 魔法攻擊, +25% 生命值, +20% 魔法防禦 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  dominator: {
    ...
    skills: [
      ...
      { name: "帕格立歐勝利",       type: "Party-Buff", rarity: "3★", effect: "+20% 攻擊力 和 +15% 暴擊 給隊伍", cooldown: "60s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "帕格立歐榮耀",          type: "Party-Buff", rarity: "3★", effect: "+20% 防禦力 和 +15% 魔法防禦 給隊伍", cooldown: "60s", duration: "300s", note: "轉職後技能仍會保留" },
      { name: "帕格立歐祝福",       type: "Party-Buff", rarity: "3★", effect: "+15% 最大生命值/魔力 給隊伍", cooldown: "60s", duration: "300s", note: "轉職後技能仍會保留" },
      ...
      { name: "帕格立歐預言",       type: "Self-Buff",  rarity: "3★", effect: "+30% 攻擊力, +25% 魔法攻擊, +20% 對怪物 傷害 持續 20 分鐘", cooldown: "55 min", duration: "20 min", note: "轉職後技能仍會保留" },
      { name: "超越火焰爆發",   type: "Ativo",      rarity: "4★", effect: "火屬性傷害 範圍 620% (10 目標) + 燃燒 10 秒", cooldown: "160s", duration: "10s", note: "轉職後技能仍會保留" },
      { name: "支配者之魂",           type: "Passivo",    rarity: "3★", effect: "+20% 魔法攻擊, +15% 生命值, +10% 全抗性", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "支配者之軀",      type: "Passivo",    rarity: "3★", effect: "+15% 最大魔力, +15% 生命值恢復, +10% 魔力恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "支配者和諧",          type: "Self-Buff",  rarity: "4★", effect: "+50% 魔法攻擊, +40% 生命值, +30% 全抗性 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  warcryer: {
    ...
    skills: [
      { name: "火焰頌歌",       type: "Party-Buff", rarity: "2★", effect: "+15% 攻擊力 給隊伍", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "戰鬥頌歌",     type: "Party-Buff", rarity: "2★", effect: "+15% 攻擊速度 給隊伍", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "防護頌歌",  type: "Party-Buff", rarity: "2★", effect: "+15% 防禦力 給隊伍", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "吸血鬼頌歌",    type: "Party-Buff", rarity: "3★", effect: "吸取 8% 傷害轉為 生命值 給隊伍", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "捕食者頌歌",   type: "Party-Buff", rarity: "2★", effect: "+10% 攻擊力 和 命中 給隊伍", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "戰狂和諧",  type: "Self-Buff",  rarity: "3★", effect: "+30% 魔法攻擊, +25% 生命值, +20% 魔法防禦 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  doomcryer: {
    ...
    skills: [
      ...
      { name: "狂戰士頌歌",         type: "Party-Buff", rarity: "3★", effect: "+25% 攻擊力, +20% 攻擊速度, -10% 防禦力 給隊伍", cooldown: "30s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "血之羈絆",                 type: "Ativo",      rarity: "3★", effect: "範圍傷害 黑暗 380% + 吸取 生命值 給隊伍", cooldown: "25s", duration: null, note: "轉職後技能仍會保留" },
      { name: "勝利預言",        type: "Self-Buff",  rarity: "3★", effect: "+30% 攻擊力, +25% 暴擊, +20% 對怪物 傷害 持續 20 分鐘", cooldown: "55 min", duration: "20 min", note: "轉職後技能仍會保留" },
      { name: "戰爭狂響",           type: "Ativo",      rarity: "3★", effect: "範圍傷害 320% + 降低 生命值/魔力 敵人 -15%", cooldown: "30s", duration: null, note: "轉職後技能仍會保留" },
      { name: "末日戰狂之魂",           type: "Passivo",    rarity: "3★", effect: "+20% 魔法攻擊, +15% 生命值, +10% 全抗性", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "末日戰狂之軀",      type: "Passivo",    rarity: "3★", effect: "+15% 最大魔力, +15% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "末日戰狂和諧",          type: "Self-Buff",  rarity: "4★", effect: "+50% 魔法攻擊, +40% 生命值, +30% 全抗性 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
    // ═══════════════════════════════════════════
  ...
  scavenger: {
    ...
    skills: [
      ...
      { name: "暈眩攻擊",      type: "Ativo",   rarity: "1★", effect: "傷害 160% + 暈眩 2 秒", cooldown: "14s", duration: "2s", note: "轉職後技能仍會保留" },
      { name: "匕首精通",   type: "Passivo", rarity: "1★", effect: "+12% 攻擊力 使用匕首時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  bountyHunter: {
    ...
    skills: [
      ...
      { name: "專注",             type: "Passivo", rarity: "1★", effect: "+10% 暴擊率", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "生命值強化",          type: "Passivo", rarity: "1★", effect: "+15% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "賞金獵人和諧", type: "Self-Buff", rarity: "3★", effect: "+30% 攻擊力, +25% 暴擊, +20% 掉落加成 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  fortuneSeeker: {
    ...
    skills: [
      ...
      { name: "工匠魔像",             type: "Ativo",   rarity: "3★", effect: "召喚 魔像 會 戰鬥 (攻擊力 200%)", cooldown: "60s", duration: "120s", note: "轉職後技能仍會保留" },
      ...
      { name: "財富獵人之魂",       type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +15% 暴擊, +20% 掉落加成", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "財富獵人之軀",      type: "Passivo", rarity: "3★", effect: "+15% 最大生命值, +10% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",            type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "財富獵人和諧",      type: "Self-Buff", rarity: "4★", effect: "+50% 攻擊力, +40% 暴擊, +35% 掉落加成 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  warsmith: {
    ...
    skills: [
      { name: "製作物品（等級2～7）",        type: "Ativo",   rarity: "2★", effect: "製作 物品 進階", cooldown: "5s", duration: null, note: "轉職後技能仍會保留" },
      { name: "召喚攻城魔像",        type: "Ativo",   rarity: "2★", effect: "魔像 強力 (攻擊力 250%, 生命值 高)", cooldown: "60s", duration: "180s", note: "轉職後技能仍會保留" },
      { name: "召喚機械魔像",     type: "Ativo",   rarity: "2★", effect: "魔像 機械 (攻擊力 遠距 200%)", cooldown: "60s", duration: "180s", note: "轉職後技能仍會保留" },
      ...
      { name: "魔像護甲",              type: "Ativo",   rarity: "2★", effect: "+30% 防禦力 的 魔像 持續 60 秒", cooldown: "60s", duration: "60s", note: "轉職後技能仍會保留" },
      { name: "戰爭工匠和諧",       type: "Self-Buff", rarity: "3★", effect: "+30% 攻擊力, +25% 魔像 威力, +20% 製作 成功 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  maestro: {
    ...
    skills: [
      { name: "召喚強化魔像",      type: "Ativo",   rarity: "3★", effect: "魔像 強化 (攻擊力 400%, 範圍)", cooldown: "90s", duration: "180s", note: "轉職後技能仍會保留" },
      ...
      { name: "最終形態",                 type: "Ativo",   rarity: "4★", effect: "魔像 進化: +100% 攻擊力/生命值 持續 60 秒", cooldown: "180s", duration: "60s", note: "轉職後技能仍會保留" },
      { name: "製作精通",              type: "Passivo", rarity: "3★", effect: "+30% 製作 成功 機率", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "巨匠之魂",             type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +15% 魔像 威力, +15% 防禦力", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "巨匠之軀",        type: "Passivo", rarity: "3★", effect: "+15% 最大生命值, +10% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",           type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "巨匠和諧",            type: "Self-Buff", rarity: "4★", effect: "+50% 攻擊力, +40% 魔像 威力, +30% 製作 成功 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
    // ═══════════════════════════════════════════
  // KAMAEL — CLASSE BASE
  ...
  kamaelSoldier: {
    ...
    skills: [
      ...
      { name: "古代劍精通", type: "Passivo", rarity: "1★", effect: "裝備古代劍時 攻擊力 +12%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  trooper: {
    ...
    skills: [
      ...
      { name: "重甲精通", type: "Passivo", rarity: "1★", effect: "+15% 防禦力 裝備重甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "生命值強化",            type: "Passivo", rarity: "1★", effect: "+12% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  berserker: {
    ...
    skills: [
      { name: "靈魂破壞者",       type: "Ativo",   rarity: "2★", effect: "傷害 靈魂 280% + 吸取 魔力", cooldown: "16s", duration: null, note: "轉職後技能仍會保留" },
      { name: "靈魂狂怒",          type: "Ativo",   rarity: "3★", effect: "+60% 攻擊力 持續 20 秒, 消耗 靈魂點數", cooldown: "60s", duration: "20s", note: "轉職後技能仍會保留" },
      ...
      { name: "靈魂穿刺",      type: "Ativo",   rarity: "2★", effect: "傷害 250% + 無視 防禦力", cooldown: "16s", duration: null, note: "轉職後技能仍會保留" },
      { name: "狂暴",             type: "Ativo",   rarity: "3★", effect: "+100% 攻擊力 當 生命值 < 30%, 持續 30 秒", cooldown: "120s", duration: "30s", note: "轉職後技能仍會保留" },
      { name: "毅力",               type: "Ativo",   rarity: "3★", effect: "以 1 生命值 存活 10 秒", cooldown: "180s", duration: "10s", note: "轉職後技能仍會保留" },
      { name: "專注",              type: "Passivo", rarity: "1★", effect: "+10% 暴擊率", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "狂戰士和諧", type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +20% 靈魂 傷害 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  doombringer: {
    ...
    skills: [
      ...
      { name: "強化靈魂狂怒",       type: "Ativo",   rarity: "4★", effect: "+80% 攻擊力 持續 25 秒", cooldown: "90s", duration: "25s", note: "轉職後技能仍會保留" },
      { name: "超越末日之刃",    type: "Ativo",   rarity: "4★", effect: "傷害 靈魂 680% + 無視 防禦力 + 吸取 靈魂", cooldown: "180s", duration: null, note: "轉職後技能仍會保留" },
      { name: "卡麥爾榮耀",            type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +15% 靈魂 傷害, +10% 暴擊率", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "末日使者之魂",         type: "Passivo", rarity: "3★", effect: "+25% 攻擊力, +20% 暴擊威力", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "末日使者之軀",        type: "Passivo", rarity: "3★", effect: "+20% 最大生命值, +15% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",           type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "末日使者和諧",        type: "Self-Buff", rarity: "4★", effect: "+55% 攻擊力, +45% 暴擊, +35% 靈魂 傷害 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  soulFinder: {
    ...
    skills: [
      ...
      { name: "細劍精通",        type: "Passivo", rarity: "1★", effect: "裝備細劍時 攻擊力 +12%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "魔力強化",            type: "Passivo", rarity: "1★", effect: "+12% 最大魔力", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  soulBreakerKamael: {
    ...
    skills: [
      ...
      { name: "靈魂破壞者和諧", type: "Self-Buff", rarity: "3★", effect: "+30% 攻擊力, +25% 魔法攻擊, +20% 靈魂 傷害 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  soulHound: {
    ...
    skills: [
      ...
      { name: "靈魂點燃",                type: "Ativo",   rarity: "3★", effect: "+50% 攻擊力 和 魔法攻擊 持續 20 秒 (吸取 生命值 3%/s)", cooldown: "90s", duration: "20s", note: "轉職後技能仍會保留" },
      ...
      { name: "靈魂獵犬之魂",            type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +20% 魔法攻擊, +15% 靈魂 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "靈魂獵犬之軀",           type: "Passivo", rarity: "3★", effect: "+15% 最大生命值/魔力, +10% 恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",             type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "靈魂獵犬和諧",           type: "Self-Buff", rarity: "4★", effect: "+50% 攻擊力, +45% 魔法攻擊, +35% 靈魂 傷害 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  warder: {
    ...
    skills: [
      ...
      { name: "弩精通",   type: "Passivo", rarity: "1★", effect: "裝備弩時 攻擊力 +12%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "生命值強化",           type: "Passivo", rarity: "1★", effect: "+10% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  soulRanger: {
    ...
    skills: [
      ...
      { name: "專注",            type: "Passivo", rarity: "1★", effect: "+10% 暴擊率", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "暴擊威力",   type: "Passivo", rarity: "2★", effect: "+20% 暴擊威力", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "靈魂遊俠和諧", type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +20% 射程 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  trickster: {
    ...
    skills: [
      ...
      { name: "超越七連矢",   type: "Ativo",   rarity: "4★", effect: "傷害 650% (7 次命中) + 元素 範圍", cooldown: "160s", duration: null, note: "轉職後技能仍會保留" },
      { name: "詭術師之魂",           type: "Passivo", rarity: "3★", effect: "+20% 攻擊力, +20% 暴擊, +15% 射程", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "詭術師之軀",          type: "Passivo", rarity: "3★", effect: "+15% 最大生命值, +10% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",           type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "詭術師和諧",          type: "Self-Buff", rarity: "4★", effect: "+55% 攻擊力, +45% 暴擊, +35% 射程 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  samuraiBase: {
    ...
    skills: [
      ...
      { name: "武士刀精通",       type: "Passivo", rarity: "1★", effect: "裝備武士刀／劍時 物理攻擊 +15%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "武士道精神",       type: "Passivo", rarity: "1★", effect: "+10% 暴擊率 和 +8% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "武士和諧",    type: "Self-Buff", rarity: "1★", effect: "+20% 物理攻擊, +15% 暴擊率 持續 30 分鐘", cooldown: "30 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  hatamoto: {
    ...
    skills: [
      ...
      { name: "武士道姿態",       type: "Toggle",  rarity: "2★", effect: "+20% 物理攻擊, +15% 暴擊率, -10% 物理防禦", cooldown: "5s", duration: "Toggle", note: "轉職後技能仍會保留" },
  ...
  ronin: {
    ...
    skills: [
      ...
      { name: "榮譽準則",           type: "Self-Buff", rarity: "3★", effect: "+30% 物理攻擊, +25% 暴擊威力, +15% 攻擊速度 持續 120 秒", cooldown: "120s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "刀之道",      type: "Passivo", rarity: "3★", effect: "裝備刀刃武器時 物理攻擊 +20%、暴擊威力 +15%", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  samurai: {
    ...
    skills: [
      { name: "終極斬",                    type: "Ativo",   rarity: "4★", effect: "處決打擊：傷害 580%（目標 生命值 低於 30% 時傷害加倍）", cooldown: "45s", duration: null, note: "轉職後技能仍會保留" },
      { name: "超越居合術",        type: "Ativo",   rarity: "4★", effect: "終極次元斬 750% + 無視 40% 的 防禦 目標的 + 流血 10 秒", cooldown: "120s", duration: "10s", note: "轉職後技能仍會保留" },
      { name: "武士之魂",               type: "Passivo", rarity: "3★", effect: "+25% 物理攻擊, +20% 暴擊威力, +15% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "武士之軀",          type: "Passivo", rarity: "3★", effect: "+20% 最大生命值, +25% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",             type: "Passivo", rarity: "4★", effect: "+15% 所有 屬性, +20% 整體暴擊傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "武士終極和諧",   type: "Self-Buff", rarity: "4★", effect: "+60% 物理攻擊, +50% 暴擊率, +35% 攻擊速度 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
    // ═══════════════════════════════════════════
  ...
  deathPilgrim: {
    ...
    skills: [
      ...
      { name: "靈魂吸取",      type: "Ativo",   rarity: "1★", effect: "傷害 140% + 吸取 20% 生命值", cooldown: "12s", duration: null, note: "轉職後技能仍會保留" },
      { name: "死亡點數精通",      type: "Passivo", rarity: "1★", effect: "產生 死亡點數 攻擊時/擊殺", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  deathMessenger: {
    ...
    skills: [
      ...
      { name: "黑暗護甲",        type: "Self-Buff", rarity: "2★", effect: "+25% 防禦力 和 +15% 黑暗 抗性 持續 20 分鐘", cooldown: "50 min", duration: "20 min", note: "轉職後技能仍會保留" },
      { name: "死亡使者和諧", type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 黑暗傷害, +20% 防禦力 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  deathKnight: {
    ...
    skills: [
      { name: "死亡風暴",                 type: "Ativo",   rarity: "3★", effect: "範圍傷害 黑暗 450% + 吸取 生命值 範圍 20%", cooldown: "30s", duration: null, note: "轉職後技能仍會保留" },
      { name: "致命反擊",              type: "Ativo",   rarity: "3★", effect: "反擊 黑暗 400% 被格擋時", cooldown: "25s", duration: null, note: "轉職後技能仍會保留" },
      { name: "終極死亡騎士",        type: "Ativo",   rarity: "4★", effect: "+80% 攻擊力 和 黑暗傷害 持續 30 秒 (消耗 所有 死亡點數)", cooldown: "120s", duration: "30s", note: "轉職後技能仍會保留" },
      { name: "超越死亡尖刺",     type: "Ativo",   rarity: "4★", effect: "傷害 黑暗 720% + 無視 防禦力 + 吸取 40% 生命值", cooldown: "180s", duration: null, note: "轉職後技能仍會保留" },
      { name: "死亡騎士意志",          type: "Passivo", rarity: "3★", effect: "+25% 攻擊力, +20% 黑暗傷害, +15% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",             type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "死亡騎士和諧",         type: "Self-Buff", rarity: "4★", effect: "+60% 攻擊力, +50% 黑暗傷害, +35% 防禦力 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  wargS0: {
    ...
    skills: [
      ...
      { name: "拳套精通",        type: "Passivo", rarity: "1★", effect: "+12% 攻擊力 使用拳套時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "輕甲精通", type: "Passivo", rarity: "1★", effect: "+8% 迴避 裝備輕甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  wargS1: {
    ...
    skills: [
      ...
      { name: "戰狼意志",         type: "Self-Buff", rarity: "2★", effect: "+20% 攻擊力 和 +15% 暴擊 持續 20 分鐘", cooldown: "50 min", duration: "20 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  wargS2: {
    ...
    skills: [
      { name: "狼形變身",        type: "Toggle",  rarity: "3★", effect: "變身 於 狼: 切換 技能, +30% 攻擊力/速度", cooldown: "10s", duration: "60s max", note: "轉職後技能仍會保留" },
      ...
      { name: "原始咆哮",                type: "Ativo",   rarity: "2★", effect: "降低 防禦力 敵人 範圍 -25% 8 秒 (狼)", cooldown: "25s", duration: "8s", note: "狼形態。轉職後技能仍會保留" },
      ...
      { name: "戰狼和諧（階段 2）",     type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 暴擊, +20% 迴避 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  wargS3: {
    ...
    skills: [
      ...
      { name: "遠古力量",                   type: "Self-Buff", rarity: "3★", effect: "+40% 攻擊力 和 防禦力 持續 60 秒", cooldown: "120s", duration: "60s", note: "轉職後技能仍會保留" },
      { name: "戰狼之魂",                     type: "Passivo", rarity: "3★", effect: "+25% 攻擊力, +20% 暴擊, +15% 迴避", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰狼精通",                    type: "Passivo", rarity: "3★", effect: "+20% 攻擊力 狼形態下, +15% 變身持續時間", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",                type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰狼和諧",                    type: "Self-Buff", rarity: "4★", effect: "+55% 攻擊力, +45% 暴擊, +35% 迴避 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  assassinS2: {
    ...
    skills: [
      ...
      { name: "殺意決心",    type: "Self-Buff", rarity: "3★", effect: "啟用 殘暴: +40% 攻擊力 持續 20 秒 (需要 3 匕首)", cooldown: "60s", duration: "20s", note: "轉職後技能仍會保留" },
      ...
      { name: "殘暴",          type: "Passivo", rarity: "2★", effect: "持有 5 把匕首時自動獲得 攻擊力 +15%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "刺客迴避", type: "Passivo", rarity: "2★", effect: "+15% 迴避, +10% 減益 抗性", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "刺客和諧（階段 2）", type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +30% 暴擊, +25% 迴避 持續 25 分鐘", cooldown: "60 min", duration: "25 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  assassinS3: {
    ...
    skills: [
      ...
      { name: "暗影大師",           type: "Passivo", rarity: "4★", effect: "+25% 攻擊力, +20% 暴擊, 暗影 獲得 +50% 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",            type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "刺客和諧",          type: "Self-Buff", rarity: "4★", effect: "+60% 攻擊力, +50% 暴擊, +40% 迴避 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  sylphGunner: {
    ...
    skills: [
      ...
      { name: "槍械精通",         type: "Passivo", rarity: "1★", effect: "裝備火器時 攻擊力 +12%", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "輕甲精通", type: "Passivo", rarity: "1★", effect: "+8% 迴避 裝備輕甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  stormBlaster: {
    ...
    skills: [
      ...
      { name: "暴風砲手之魂",        type: "Passivo", rarity: "3★", effect: "+25% 攻擊力, +20% 暴擊, +15% 風屬性傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "暴風砲手之軀",   type: "Passivo", rarity: "3★", effect: "+15% 最大生命值, +10% 迴避, +10% 移動速度", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",            type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "暴風砲手和諧",       type: "Self-Buff", rarity: "4★", effect: "+60% 攻擊力, +50% 暴擊, +35% 風屬性傷害 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  highElfBase: {
    ...
    skills: [
      ...
      { name: "高等精靈精通",   type: "Passivo", rarity: "1★", effect: "+10% 物理攻擊 和 魔法攻擊", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "魔力提升",        type: "Passivo", rarity: "1★", effect: "+10% 最大魔力", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  divineTemplarBase: {
    ...
    skills: [
      ...
      { name: "神聖盾牌精通", type: "Passivo", rarity: "1★", effect: "+12% 防禦力 裝備盾牌時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "重甲精通", type: "Passivo", rarity: "1★", effect: "+10% 防禦力 裝備重甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  ...
  divineTemplarS1: {
    ...
    skills: [
      ...
      { name: "神聖盾牌精通", type: "Passivo", rarity: "1★", effect: "+15% 防禦力 裝備盾牌時", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "重甲精通", type: "Passivo", rarity: "1★", effect: "+15% 防禦力 裝備重甲時", cooldown: null, duration: null, note: "轉職後技能仍會保留" }
    ]
  },
  lightTemplar: {
  ...
  divineTemplarS3: {
    ...
    skills: [
      { name: "領主騎士",                   type: "Ativo",   rarity: "4★", effect: "神聖形態: +50% 防禦力 和 攻擊力 持續 30 秒 + 恢復 魔力", cooldown: "120s", duration: "30s", note: "轉職後技能仍會保留" },
      ...
      { name: "領主騎士光環",            type: "Self-Buff", rarity: "3★", effect: "+30% 防禦力 和 +20% 攻擊力 給隊伍 持續 120 秒", cooldown: "120s", duration: "120s", note: "轉職後技能仍會保留" },
      { name: "神聖聖騎士之魂",         type: "Passivo", rarity: "3★", effect: "+25% 防禦力, +20% 最大生命值, +15% 神聖傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "神聖聖騎士之軀",        type: "Passivo", rarity: "3★", effect: "+20% 最大生命值, +15% 魔法防禦, +15% 生命值恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",              type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "神聖聖騎士和諧",        type: "Self-Buff", rarity: "4★", effect: "+60% 防禦力, +45% 最大生命值, +35% 神聖傷害 持續 30 分鐘", cooldown: "90 min", duration: "30 min", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  elementWeaverS3: {
    ...
    skills: [
      ...
      { name: "元素編織者之軀",      type: "Passivo", rarity: "3★", effect: "+15% 最大魔力, +15% 魔力恢復", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",            type: "Passivo", rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  shineMakerS1: {
    ...
    skills: [
      ...
      { name: "光耀屏障",    type: "Self-Buff", rarity: "2★", effect: "+15% 防禦力 和 魔法防禦 持續 120 秒", cooldown: "60s", duration: "120s", note: "轉職後技能仍會保留" }
    ]
  },
  ...
  shineMakerS3: {
    ...
    skills: [
      ...
      { name: "光耀創造者之軀",       type: "Passivo",   rarity: "3★", effect: "+15% 最大魔力, +15% 魔力恢復, +10% 最大生命值", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
      { name: "戰鬥大師",             type: "Passivo",   rarity: "4★", effect: "+10% 全屬性, +15% 對怪物 傷害", cooldown: null, duration: null, note: "轉職後技能仍會保留" },
  ...
  divineTemplar: {
    ...
    base: { atk: 72, def: 98, hp: 750, mp: 145, eva: 14, crit: 8, mdef: 68 },
    skills: [
      { name: "領主騎士",                   type: "Ativo",   rarity: "4★", effect: "神聖形態: +50% 防禦力 和 攻擊力 持續 30 秒 + 恢復 魔力", cooldown: "120s", duration: "30s" },
      ...
      { name: "神聖聖騎士和諧",        type: "Self-Buff", rarity: "4★", effect: "+60% 防禦力, +45% 最大生命值, +35% 神聖傷害 持續 30 分鐘", cooldown: "90 min", duration: "30 min" }
    ]
  },
  elementWeaver: {
    name: '元素編織者', parent: 'elementWeaverS2', race: 'highelf', archetype: 'mage', stage: 3,
  ...
  wargBase: {
    ...
    skills: [
      ...
      { name: "野獸咆哮",                 type: "Self-Buff", rarity: "1★", effect: "+15% 攻擊力, +10% 攻擊速度 60 秒", cooldown: "45s" },
  ...
  wargS1: {
    ...
    skills: [
      ...
      { name: "野獸咆哮",                 type: "Self-Buff", rarity: "2★", effect: "+25% 攻擊力, +20% 攻擊速度 60 秒", cooldown: "45s" },
      { name: "祖狼變身", type: "Self-Buff", rarity: "4★", effect: "變身: +50% 攻擊力, +40% 暴擊傷害 持續 60 秒", cooldown: "90s" },
      { name: "吸血野性撕咬",        type: "Ativo",     rarity: "3★", effect: "吸血撕咬 240% + 恢復 40% 傷害轉為 生命值", cooldown: "14s" }
    ]
  },
  wargS2: {
    ...
    skills: [
      ...
      { name: "野獸咆哮",                 type: "Self-Buff", rarity: "2★", effect: "+30% 攻擊力, +20% 攻擊速度 60 秒", cooldown: "45s" },
      { name: "祖狼變身", type: "Self-Buff", rarity: "4★", effect: "變身: +55% 攻擊力, +40% 暴擊傷害 持續 60 秒", cooldown: "90s" },
      { name: "吸血野性撕咬",        type: "Ativo",     rarity: "3★", effect: "吸血撕咬 260% + 恢復 40% 傷害轉為 生命值", cooldown: "14s" }
    ]
  },
  wargS3: {
    ...
    skills: [
      ...
      { name: "野獸咆哮",                 type: "Self-Buff", rarity: "3★", effect: "+35% 攻擊力, +25% 攻擊速度 持續 120 秒", cooldown: "45s" },
      { name: "祖狼變身", type: "Self-Buff", rarity: "4★", effect: "變身為祖狼: +60% 攻擊力, +45% 暴擊傷害 持續 60 秒", cooldown: "90s" },
      { name: "吸血野性撕咬",        type: "Ativo",     rarity: "4★", effect: "吸血撕咬 320% + 恢復 50% 傷害轉為 生命值", cooldown: "14s" }
    ]
  },
  warg: {
  ...
  shineMakerBase: {
    ...
    skills: [
      ...
      { name: "水晶武器精通",       type: "Passivo",   rarity: "1★", effect: "裝備戰鎚／鈍器時 攻擊力 +15%", cooldown: null },
  ...
  shinemakerS1: {
    ...
    skills: [
      ...
      { name: "水晶祝福",             type: "Passivo",   rarity: "1★", effect: "+15% 最大魔力 和 +12% 魔力恢復", cooldown: null }
    ]
  },
  shinemakerS2: {
    ...
    skills: [
      ...
      { name: "光耀屏障",                type: "Ativo",     rarity: "3★", effect: "護盾 神聖 的 25% 最大生命值 持續 20 秒", cooldown: "35s" },
  ...
  bloodRoseBase: {
    ...
    skills: [
      ...
      { name: "血色脈動",               type: "Ativo",     rarity: "1★", effect: "脈動 的 血: 傷害 140% + 吸取 30% 於 生命值", cooldown: "8s" },
  ...
  bloodRoseS1: {
    ...
    skills: [
      ...
      { name: "血色汲取",               type: "Ativo",     rarity: "2★", effect: "傷害 暗影 200% + 吸收 50% 傷害轉為 生命值", cooldown: "10s" },
  ...
  marauderBase: {
    ...
    skills: [
      ...
      { name: "拳術精通",                 type: "Passivo",   rarity: "1★", effect: "裝備利爪／拳套時 物理攻擊 +15%", cooldown: null },
      { name: "賽哈和諧",              type: "Self-Buff", rarity: "1★", effect: "+20% 物理攻擊, +15% 攻擊速度 持續 30 分鐘", cooldown: "30 min" }
    ]
  },
  marauder: {
  ...
  ertheiaWarrior: {
    ...
    skills: [
      ...
      { name: "風之戰士精通",         type: "Passivo",   rarity: "3★", effect: "+20% 物理攻擊, +20% 暴擊率 和 +15% 攻擊速度", cooldown: null }
    ]
  },
  eviscerator: {
    ...
    skills: [
      ...
      { name: "裂空者終極和諧", type: "Self-Buff", rarity: "4★", effect: "+60% 物理攻擊, +40% 暴擊威力, +35% 攻擊速度 持續 30 分鐘", cooldown: "90 min" }
    ]
  },
