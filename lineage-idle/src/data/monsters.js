...
export const MONSTERS = {
  ...
  fafurion: { name: '水之君主法利昂', lvl: 69, hp: 45000, atk: 1100, def: 440, eva: 12, xp: 32000, sp: 350, gold: [14000, 28000], boss: true },
  ...
  cerberus: { name: '地獄守護者刻耳柏洛斯', lvl: 75, hp: 58000, atk: 1350, def: 520, eva: 14, xp: 42000, sp: 450, gold: [18000, 36000], boss: true },
  ...
  splendorLight: { name: '光輝之光君主', lvl: 74, hp: 25000, atk: 1020, def: 390, eva: 14, xp: 26000, sp: 260, gold: [8000, 16000], element: 'holy' },
  celestialArchon: { name: '天界光明統領', lvl: 74, hp: 22500, atk: 600, def: 360, eva: 16, matk: 1100, mdef: 470, xp: 27000, sp: 270, gold: [8500, 17000], element: 'holy', magic: true },
  ...
  screamingSouls: { name: '受苦尖嘯靈魂', lvl: 75, hp: 22000, atk: 600, def: 350, eva: 22, matk: 1200, mdef: 500, xp: 28000, sp: 280, gold: [8800, 17500], element: 'dark', magic: true },
  stakatoWarrior: { name: '史塔卡拓裝甲戰士', lvl: 75, hp: 29000, atk: 1120, def: 440, eva: 12, xp: 29500, sp: 290, gold: [9200, 18500] },
  stakatoQueenBrood: { name: '史塔卡拓女王巢母', lvl: 76, hp: 46000, atk: 1300, def: 520, eva: 14, matk: 1100, mdef: 480, xp: 39000, sp: 420, gold: [15000, 31000], elite: true },
  swampAbomination: { name: '沼澤憎惡巨人', lvl: 76, hp: 68000, atk: 1550, def: 590, eva: 14, xp: 52000, sp: 520, gold: [22000, 44000], boss: true },

  // ──────────────────────────────────────────────────────────────────────────
  // 20. ADEN CITY (Level 76-79)
  // ──────────────────────────────────────────────────────────────────────────
  royalKnight: { name: '亞丁皇家衛兵', lvl: 76, hp: 22000, atk: 980, def: 380, eva: 8, xp: 24000, sp: 240, gold: [7500, 15000] },
  highMage: { name: '亞丁高階織法師', lvl: 77, hp: 19000, atk: 450, def: 320, eva: 10, matk: 1150, mdef: 450, xp: 28000, sp: 270, gold: [8800, 18000], magic: true },
  ...
  lindvior: { name: '風之君主林德拜爾', lvl: 84, hp: 95000, atk: 2100, def: 820, eva: 20, xp: 110000, sp: 800, gold: [35000, 70000], element: 'wind', boss: true },
  ...
  sepulcherArchon: { name: '陵墓統領', lvl: 86, hp: 44000, atk: 700, def: 500, eva: 12, matk: 1850, mdef: 750, xp: 58000, sp: 470, gold: [17500, 35000], element: 'dark', magic: true },
  ...
  deathKing: { name: '至尊死亡之王', lvl: 89, hp: 130000, atk: 2600, def: 1050, eva: 15, xp: 180000, sp: 1200, gold: [55000, 110000], boss: true },
  ...
  earthDrake: { name: '大地飛龍', lvl: 92, hp: 95000, atk: 2700, def: 1080, eva: 12, xp: 150000, sp: 1000, gold: [45000, 90000], element: 'earth' },
  caveWyrmBehemoth: { name: '洞穴巨蟒巨獸', lvl: 93, hp: 115000, atk: 2900, def: 1180, eva: 10, xp: 175000, sp: 1150, gold: [52000, 105000], element: 'earth' },
  ...
  antharas: { name: '地龍之王安塔瑞斯', lvl: 94, hp: 250000, atk: 3800, def: 1500, eva: 15, xp: 350000, sp: 2200, gold: [100000, 200000], element: 'earth', boss: true },
  ...
  flameArchon: { name: '烈焰統領', lvl: 97, hp: 125000, atk: 1300, def: 1100, eva: 14, matk: 3600, mdef: 1500, xp: 210000, sp: 1350, gold: [60000, 120000], element: 'fire', magic: true },
  ...
  valakas: { name: '火龍君主巴拉卡斯', lvl: 100, hp: 450000, atk: 5500, def: 2200, eva: 20, xp: 800000, sp: 4500, gold: [250000, 500000], element: 'fire', boss: true },
  ...
  necro_nephilim_sentinel: { name: '涅菲林哨兵', lvl: 32, hp: 1350, atk: 48, def: 44, eva: 6, matk: 0, mdef: 28, xp: 290, sp: 22, gold: [90, 180], traits: ['block'], element: 'holy' },
  necro_tomb_priest: { name: '陵墓審判祭司', lvl: 33, hp: 1100, atk: 35, def: 32, eva: 7, matk: 60, mdef: 45, xp: 310, sp: 25, gold: [100, 200], magic: true, element: 'dark' },
  necro_sacrifice_boss: { name: '祭品統領', lvl: 35, hp: 6500, atk: 85, def: 75, eva: 8, matk: 80, mdef: 65, xp: 1800, sp: 150, gold: [400, 900], boss: true, element: 'dark' },
  ...
  necro_nephilim_guard: { name: '涅菲林皇家衛兵', lvl: 42, hp: 2500, atk: 105, def: 90, eva: 10, matk: 0, mdef: 65, xp: 680, sp: 50, gold: [200, 400], traits: ['block'], element: 'holy' },
  necro_crypt_shaman: { name: '巡禮者墓穴薩滿', lvl: 43, hp: 2000, atk: 70, def: 68, eva: 12, matk: 120, mdef: 85, xp: 720, sp: 55, gold: [220, 450], magic: true, element: 'dark' },
  necro_pilgrim_boss: { name: '巡禮者暗影領主', lvl: 45, hp: 12000, atk: 160, def: 140, eva: 12, matk: 150, mdef: 120, xp: 4500, sp: 400, gold: [800, 1800], boss: true, element: 'dark' },
  ...
  necro_lilim_magus: { name: '莉莉姆大魔導師', lvl: 52, hp: 3400, atk: 110, def: 115, eva: 15, matk: 220, mdef: 150, xp: 1350, sp: 100, gold: [400, 800], magic: true, element: 'dark' },
  ...
  necro_worship_boss: { name: '禮拜者高階審判官', lvl: 55, hp: 24000, atk: 280, def: 230, eva: 15, matk: 290, mdef: 210, xp: 9500, sp: 850, gold: [1600, 3500], boss: true, element: 'dark' },

  // Necropolis of Patriots (Lv 62)
  necro_patriot_berserker: { name: '愛國者莉莉姆狂戰士', lvl: 61, hp: 5800, atk: 260, def: 210, eva: 15, matk: 0, mdef: 160, xp: 2200, sp: 180, gold: [600, 1200], traits: ['enrage'], element: 'dark' },
  necro_patriot_bishop: { name: '涅菲林大主教', lvl: 62, hp: 5200, atk: 180, def: 190, eva: 16, matk: 340, mdef: 240, xp: 2400, sp: 200, gold: [650, 1300], magic: true, element: 'holy' },
  ...
  necro_patriot_boss: { name: '黃昏愛國者將軍', lvl: 65, hp: 42000, atk: 420, def: 350, eva: 18, matk: 380, mdef: 320, xp: 18000, sp: 1600, gold: [3000, 7000], boss: true, element: 'dark' },
  ...
  necro_ascetic_crusader: { name: '涅菲林神聖十字軍', lvl: 72, hp: 9500, atk: 420, def: 370, eva: 16, matk: 0, mdef: 280, xp: 4600, sp: 390, gold: [1200, 2400], traits: ['block'], element: 'holy' },
  necro_ascetic_seer: { name: '禁慾者虛空先知', lvl: 73, hp: 7800, atk: 250, def: 280, eva: 18, matk: 520, mdef: 380, xp: 4900, sp: 420, gold: [1300, 2600], magic: true, element: 'dark' },
  necro_ascetic_boss: { name: '禁慾者大師', lvl: 74, hp: 65000, atk: 620, def: 520, eva: 20, matk: 580, mdef: 480, xp: 32000, sp: 2800, gold: [5500, 12000], boss: true, element: 'dark' },
  ...
  necro_martyr_sorcerer: { name: '殉教者靈魂術士', lvl: 77, hp: 10500, atk: 320, def: 380, eva: 20, matk: 690, mdef: 490, xp: 7400, sp: 640, gold: [2000, 4000], magic: true, element: 'dark' },
  necro_martyr_gargoyle: { name: '遠古死靈石像鬼', lvl: 78, hp: 14000, atk: 590, def: 510, eva: 16, matk: 200, mdef: 420, xp: 8200, sp: 700, gold: [2200, 4500], element: 'earth' },
  necro_martyr_boss: { name: '殉教者領主', lvl: 78, hp: 95000, atk: 850, def: 720, eva: 22, matk: 780, mdef: 680, xp: 55000, sp: 4800, gold: [9000, 20000], boss: true, element: 'dark' },
  ...
  necro_apostle_behemoth: { name: '使徒陵墓巨獸', lvl: 82, hp: 22000, atk: 780, def: 680, eva: 14, matk: 0, mdef: 540, xp: 14500, sp: 1250, gold: [3800, 7500], elite: true, element: 'dark' },
  ...
  necro_disciple_knight: { name: '席琳莉莉姆騎士', lvl: 84, hp: 22000, atk: 880, def: 750, eva: 26, matk: 0, mdef: 620, xp: 18000, sp: 1600, gold: [4500, 9000], traits: ['bleed'], element: 'dark' },
  necro_disciple_sorceress: { name: '門徒深淵女術士', lvl: 84, hp: 18500, atk: 520, def: 620, eva: 28, matk: 1150, mdef: 840, xp: 21000, sp: 1850, gold: [5000, 10000], magic: true, element: 'dark' },
  necro_disciple_executioner: { name: '席琳死亡劊子手', lvl: 85, hp: 28000, atk: 990, def: 860, eva: 22, matk: 0, mdef: 720, xp: 26000, sp: 2300, gold: [6000, 12000], elite: true, element: 'dark' },
