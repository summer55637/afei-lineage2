...
export const GUIDES_DATA = {
  ...
  shop: {
    ...
    sections: [
      {
        heading: '🧪 生存消耗品',
        text: '補充 生命值 藥水（P、M、G、XL）、魔力 藥水與 靈魂彈／魔靈彈，避免自動戰鬥因補給不足而中斷。',
  ...
  craft: {
    ...
    sections: [
      ...
      {
        heading: '🔮 靈魂水晶（SA）',
        text: '鍛造並在武器上鑲嵌紅、綠、藍靈魂水晶，可解鎖特殊能力（SA），例如 生命（+25% 生命值）、專注（+80 暴擊）或 靈敏（+15% 施法）。',
        tip: '你可以融合 2 顆相同等級的靈魂水晶來提升階級。'
      },
      {
        heading: '✨ 普希金大師 MW（名匠）',
        text: '將一般裝備交給 普希金 大師，可鍛造成 **名匠（MW）** 版本，獲得額外屬性加成與閃耀特效。',
      ...
      {
        heading: '🎗️ 腰帶合成 [S]',
        text: '可花費 500k 金幣，以 70% 成功率合成傳說級 **祝福最高級魔法飾品腰帶 [S]**，提供 **+7.2% PVE 防禦** 與 **+6% 傷害**。',
        tip: '祝福腰帶是遊戲中非常優秀的防禦裝備！'
      },
      {
        heading: '💎 附魔改造／生命石',
        text: '在武器與史詩飾品（蟻后、巴溫、瓦拉卡斯、札肯、安塔瑞斯）上使用高級生命石，可解鎖被動物品技能（力量、Empower、護盾、專注、Celestial）。',
        tip: 'Celestial 護盾 技能可提供 7 秒完全無敵！'
      }
    ]
  },
  ...
  codex: {
    ...
    sections: [
      {
        heading: '📚 裝備收藏',
        text: '取得重複的裝備與飾品後，可登錄至圖鑑。完成一組收藏會獲得永久加成，例如 +物理攻擊、+魔法攻擊、+生命值 或 +Def。',
  ...
  raids: {
    ...
    sections: [
      ...
      },
      {
        ...
        tip: '把最強技能與 靈魂彈 留到 BREAK 期間一次爆發！'
      },
      {
        heading: '🎫 每日 團隊首領 入場券',
  ...
  referral: {
    ...
    sections: [
      ...
      },
      {
        ...
        text: '導師系統能連結資深玩家與新手：\n• **我是新手（等級 20 以下）：** 綁定資深導師後立即獲得 **永久 +10% E經驗值**、**1,000 發無級別魂彈／魔靈彈** 與 **10 瓶生命藥水**。\n• **成長里程碑（等級 40）：** 完成二轉後，學員與導師都會獲得 **50 亞丁幣（AC）** 與 **5 張祝福武器卷軸**。\n• **快速綁定：** 從好友清單選人並點擊 **「🎓 設為導師」** 即可。',
